...
begin
 ...
 CL.AddTypeS('HDBIDB', 'longword');
  ...
  CL.AddTypeS('TPasswordEvent', 'Procedure ( Sender : TObject; var Continue : B'
   +'oolean)');
  ...
  CL.AddTypeS('TTransIsolation', '( tiDirtyRead, tiReadCommitted, tiRepeatableR'
   +'ead )');
  ...
  CL.AddTypeS('TBatchMode', '( batAppend, batUpdate, batAppendUpdate, batDelete'
   +', batCopy )');
