...
type
  ...
  protected
    ...
    procedure Reset;
  public
    //function HashValue1(AStream: TStream): T4x4LongWordRecord; override;
  end;

  //TIdHashMessageDigest4 = class(TIdHashMessageDigest)
  TIdHashMessageDigest4 = class(TObject)
  protected
  ...
  //var idhm4: TIdHashMessageDigest4;
...
function TIdHashMessageDigest4.AsHex(const AValue: T4x4LongWordRecord): string;
var
  P: PChar;
  i: Integer;
Begin
...
destructor TIdHashMessageDigest4.Destroy;
begin
//
end;
...
function TIdHashMessageDigest4.HashValue1(AStream: TStream): T4x4LongWordRecord;
Var
  LStartPos: Integer;
  LBitSize,
  LSize: Int64;
...
begin
  ...
  while LSize - AStream.Position >= SizeOf(FCBuffer) do begin
    AStream.Read(FCBuffer[0], SizeOf(FCBuffer));
    MDCoder;
  end;
  ...
  if Length(S1) > 64 - SizeOf(LSize) then begin
