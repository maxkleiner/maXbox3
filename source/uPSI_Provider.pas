...
begin
  ...
  with CL.AddClassN(CL.FindClass('TInterfacedObject'),'TLocalAppServer') do
  begin
...
begin
  ...
  with CL.AddClassN(CL.FindClass('TCustomResolver'),'TSQLResolver') do
  begin
...
begin
  ...
  with CL.AddClassN(CL.FindClass('TCustomPacketWriter'),'TDataPacketWriter') do
  begin
...
begin
  ...
  with CL.AddClassN(CL.FindClass('TObject'),'TCustomPacketWriter') do
  begin
...
begin
  ...
  with CL.AddClassN(CL.FindClass('Exception'),'EDSWriter') do
  begin
...
procedure RIRegister_TLocalAppServer(CL: TPSRuntimeClassImporter);
begin
  with CL.Add(TLocalAppServer) do
  begin
...
procedure RIRegister_TDataSetResolver(CL: TPSRuntimeClassImporter);
begin
  with CL.Add(TDataSetResolver) do
  begin
