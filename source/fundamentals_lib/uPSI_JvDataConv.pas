unit uPSI_JvDataConv;
{
  more than a oonverter
}
interface
...
type 
(*----------------------------------------------------------------------------*)
  TPSImport_JvDataConv = class(TPSPlugin)
  protected
...
procedure SIRegister_JvDataConv(CL: TPSPascalCompiler);
...
procedure RIRegister_JvDataConv(CL: TPSRuntimeClassImporter);
...
procedure Register;
begin
  RegisterComponents('Pascal Script', [TPSImport_JvDataConv]);
end;
...
procedure SIRegister_TJvConverter(CL: TPSPascalCompiler);
begin
  //with RegClassS(CL,'TComponent', 'TJvConverter') do
  with CL.AddClassN(CL.FindClass('TComponent'),'TJvConverter') do begin
...
begin
  ...
  with CL.AddClassN(CL.FindClass('TPersistent'),'TJvDateTimeFormat') do begin
...
procedure SIRegister_JvDataConv(CL: TPSPascalCompiler);
begin
  CL.AddTypeS('TDataTypeJ', '( dtString, dtInteger, dtFloat, dtDateTime, dtDate,'
   +' dtTime, dtBoolean )');
...
{ TPSImport_JvDataConv }
(*----------------------------------------------------------------------------*)
procedure TPSImport_JvDataConv.CompileImport1(CompExec: TPSScript);
begin
  SIRegister_JvDataConv(CompExec.Comp);
end;
(*----------------------------------------------------------------------------*)
procedure TPSImport_JvDataConv.ExecImport1(CompExec: TPSScript; const ri: TPSRuntimeClassImporter);
begin
  RIRegister_JvDataConv(ri);
end;
(*----------------------------------------------------------------------------*)
