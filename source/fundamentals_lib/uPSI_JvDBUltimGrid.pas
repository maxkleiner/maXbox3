...
begin
  ...
  with CL.AddClassN(CL.FindClass('TJvDBGrid'),'TJvDBUltimGrid') do
  begin
...
begin
 ...
 CL.AddConstantN('JvGridSort_DOWN','Boolean')BoolToStr( True);
  ...
  CL.AddTypeS('TIndexNotFoundEvent', 'Procedure ( Sender : TJvDBUltimGrid; Fiel'
   +'dsToSort : TSortFields; IndexFieldNames : string; DescFields : string; var'
   +' Retry : Boolean)');
  ...
  CL.AddTypeS('TGetSortFieldNameEvent', 'Procedure ( Sender : TJvDBUltimGrid; v'
   +'ar FieldName : string)');
