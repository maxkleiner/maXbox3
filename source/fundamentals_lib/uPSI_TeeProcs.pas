...
begin
  ...
  with CL.AddClassN(CL.FindClass('TTeeCustomShape'),'TTeeShape') do
  begin
  end;
end;
...
begin
  ...
  with CL.AddClassN(CL.FindClass('TPersistent'),'TTeeCustomShapeBrushPen') do
  begin
...
begin
  ...
  with CL.AddClassN(CL.FindClass('TOBJECT'),'TTeeZoom') do
  begin
    RegisterMethod('Constructor Create');
    RegisterMethod('Procedure Assign( Source : TPersistent)');
...
begin
  ...
  with CL.AddClassN(CL.FindClass('TOBJECT'),'TTeeZoomBrush') do
  begin
  end;
end;
...
begin
  ...
  with CL.AddClassN(CL.FindClass('TChartPen'),'TTeeZoomPen') do
  begin
...
begin
  ...
  with CL.AddClassN(CL.FindClass('TOBJECT'),'TTeeEventListeners') do begin
...
begin
  ...
  with CL.AddClassN(CL.FindClass('TCustomPanel'),'TCustomPanelNoCaption') do
  begin
  end;
end;
...
begin
 ...
 //CL.AddDelphiFunction('Function ScreenRatio( ACanvas : TCanvas3D) : Double');
...
begin
 ...
 S.RegisterDelphiFunction(@ScreenRatio, 'ScreenRatio', cdRegister);
...
procedure RIRegister_TTeeEvent(CL: TPSRuntimeClassImporter);
begin
  with CL.Add(TTeeEvent) do
  begin
    RegisterPropertyHelper(@TTeeEventSender_R,@TTeeEventSender_W,'Sender');
    RegisterVirtualConstructor(@TTeeEvent.Create, 'Create');
  end;
end;
...
procedure RIRegister_TCustomPanelNoCaption(CL: TPSRuntimeClassImporter);
begin
  with CL.Add(TCustomPanelNoCaption) do
  begin
  end;
end;
