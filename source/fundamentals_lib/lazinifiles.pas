...
override;
  ...
  TLIniFile = class(TLCustomIniFile)
    FStream: TStream;
  private
  ...
  public
    constructor Create(const AFileName: string);
    constructor Create1(AStream: TStream); //overload;
...
constructor TLCustomIniFile.Create(const AFileName: string);
begin
  FFileName := AFileName;
...
destructor TLCustomIniFile.Destroy;
begin
  FSectionList.Free;
  inherited Destroy;
end;

function TLCustomIniFile.SectionExists(const Section: string): Boolean;
begin
  Result := (FSectionList.SectionByName(Section) <> nil);
end;

function TLCustomIniFile.ReadInteger(const Section, Ident: string; Default: Longint): Longint;
var
  s: string;
begin
  Result := Default;
...
procedure TLCustomIniFile.WriteInteger(const Section, Ident: string; Value: Longint);
begin
  WriteString(Section, Ident, IntToStr(Value));
end;

function TLCustomIniFile.ReadBool(const Section, Ident: string; Default: Boolean): Boolean;
var
  s: string;
begin
  Result := Default;
...
procedure TLCustomIniFile.WriteBool(const Section, Ident: string; Value: Boolean);
begin
  WriteString(Section, Ident, BoolToChar(Value));
end;

function TLCustomIniFile.ReadDate(const Section, Ident: string; Default: TDateTime): TDateTime;
var
  s: string;
begin
  Result := Default;
...
function TLCustomIniFile.ReadDateTime(const Section, Ident: string; Default: TDateTime): TDateTime;
var
  s: string;
begin
  Result := Default;
...
function TLCustomIniFile.ReadFloat(const Section, Ident: string; Default: Double): Double;
var
  s: string;
begin
  Result := Default;
...
function TLCustomIniFile.ReadTime(const Section, Ident: string; Default: TDateTime): TDateTime;
var
  s: string;
begin
  Result := Default;
...
procedure TLCustomIniFile.WriteDate(const Section, Ident: string; Value: TDateTime);
begin
  WriteString(Section, Ident, DateToStr(Value));
end;

procedure TLCustomIniFile.WriteDateTime(const Section, Ident: string; Value: TDateTime);
begin
  WriteString(Section, Ident, DateTimeToStr(Value));
end;

procedure TLCustomIniFile.WriteFloat(const Section, Ident: string; Value: Double);
begin
  WriteString(Section, Ident, FloatToStr(Value));
end;

procedure TLCustomIniFile.WriteTime(const Section, Ident: string; Value: TDateTime);
begin
  WriteString(Section, Ident, TimeToStr(Value));
end;

function TLCustomIniFile.ValueExists(const Section, Ident: string): Boolean;
var
...
constructor TLIniFile.Create(const AFileName: string);
var
  slLines: TStringList;
begin
...
constructor TLIniFile.Create1(AStream: TStream);
var
  slLines: TStringList;
begin
  inherited Create('');
...
procedure TLIniFile.FillSectionList(AStrings: TStrings);
var
  i,j: integer;
...
function TLIniFile.ReadString(const Section, Ident, Default: string): string;
var
  oSection: TIniFileSection;
  oKey: TIniFileKey;
begin
...
procedure TLIniFile.WriteStringInMemory(const Section, Ident, Value: String);
var
  oSection: TIniFileSection;
  oKey: TIniFileKey;
begin
...
procedure TLIniFile.WriteString(const Section, Ident, Value: String);
begin
  if (Section > '') and (Ident > '') then begin
...
procedure TLIniFile.ReadSection(const Section: string; Strings: TStrings);
var
  oSection: TIniFileSection;
  i: integer;
begin
...
procedure TLIniFile.ReadSectionRaw(const Section: string; Strings: TStrings);
var
  oSection: TIniFileSection;
  i: integer;
begin
...
procedure TLIniFile.ReadSections(Strings: TStrings);
var
  i: integer;
begin
  Strings.BeginUpdate;
...
procedure TLIniFile.ReadSectionValues(const Section: string; Strings: TStrings);
var
  oSection: TIniFileSection;
  s: string;
  i: integer;
...
procedure TLIniFile.EraseSection(const Section: string);
var
  oSection: TIniFileSection;
begin
  oSection := FSectionList.SectionByName(Section);
...
procedure TLIniFile.DeleteKey(const Section, Ident: String);
var
 oSection: TIniFileSection;
 oKey: TIniFileKey;
begin
...
procedure TLIniFile.UpdateFile;
var
  slLines: TStringList;
  i, j: integer;
begin
...
procedure TLMemIniFile.Clear;
begin
  FSectionList.Clear;
end;

procedure TLMemIniFile.GetStrings(List: TStrings);
var
  i, j: integer;
  oSection: TIniFileSection;
begin
...
procedure TLMemIniFile.Rename(const AFileName: string; Reload: Boolean);
var
  slLines: TStringList;
begin
  FFileName := AFileName;
...
procedure TLMemIniFile.SetStrings(List: TStrings);
begin
  FillSectionList(List);
end;

procedure TLMemIniFile.WriteString(const Section, Ident, Value: String);
begin
  if (Section > '') and (Ident > '') then begin
    WriteStringInMemory(Section, Ident, Value);
  end;
