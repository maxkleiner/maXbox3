...
type
  ...
  TJvMathParser2 = class(TComponent)
  private
    FInput: string;
...
begin
  ...
  FParser := TJvMathParser2.Create(Self);
...
constructor TJvMathParser2.Create(AOwner: TComponent);
begin
  inherited Create(AOwner);
  { defaults }
  FInput := '';
...
function TJvMathParser2.GotoState(Production: Word): Word;
var
  State: Word;
begin
...
function TJvMathParser2.IsFunc(S: string): Boolean;
var
  P, SLen: Word;
  FuncName: string;
begin
...
function TJvMathParser2.IsVar(var Value: Extended): Boolean;
var
  VarName: string;
  VarFound: Boolean;
begin
...
function TJvMathParser2.NextToken: TokenTypes;
var
  NumString: string;
  TLen, NumLen: Word;
  Check: Integer;
...
procedure TJvMathParser2.Pop(var Token: TokenRec);
begin
...
procedure TJvMathParser2.Push(Token: TokenRec);
begin
...
procedure TJvMathParser2.Parse;
var
  FirstToken: TokenRec;
  Accepted: Boolean;
begin
...
procedure TJvMathParser2.Reduce(Reduction: Word);
var
...
procedure TJvMathParser2.Shift(State: Word);
begin
