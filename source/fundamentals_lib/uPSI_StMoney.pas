...
begin
  ...
  with CL.AddClassN(CL.FindClass('TObject'),'TStMoney') do
  begin
...
begin
  ...
  with CL.AddClassN(CL.FindClass('TObject'),'TStExchangeRateList') do
  begin
    RegisterMethod('Constructor Create');
...
begin
  ...
  with CL.AddClassN(CL.FindClass('TObject'),'TStExchangeRate') do
  begin
    RegisterMethod('Constructor Create');
...
begin
  ...
  with CL.AddClassN(CL.FindClass('TObject'),'TStCurrencyList') do
  begin
    RegisterMethod('Constructor Create');
...
begin
  ...
  CL.AddTypeS('TStConversionType', '( ctUnknown, ctTriangular, ctMultiply, ctDi'
   +'vide )');
  CL.AddTypeS('TStGetRateUpdateEvent', 'Procedure ( Sender : TObject; NewRate :'
   +' TStDecimal; var NewDate : TDateTime)');
...
procedure RIRegister_TStExchangeRateList(CL: TPSRuntimeClassImporter);
begin
  with CL.Add(TStExchangeRateList) do
  begin
...
procedure RIRegister_TStExchangeRate(CL: TPSRuntimeClassImporter);
begin
  with CL.Add(TStExchangeRate) do
  begin
...
procedure RIRegister_TStCurrencyList(CL: TPSRuntimeClassImporter);
begin
  with CL.Add(TStCurrencyList) do
  begin
