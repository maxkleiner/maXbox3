...
begin
  ...
  with CL.AddClassN(CL.FindClass('TJvComponent'),'TJvBDESQLScript') do
  begin
...
begin
  ...
  CL.AddTypeS('TOnScriptProgress', 'Procedure ( Sender : TJvBDESQLScript; var C'
   +'ancel : Boolean; Line : Integer)');
