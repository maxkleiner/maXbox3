...
begin
  ...
  with CL.AddClassN(CL.FindClass('TComponent'),'TTeeSeriesSource') do
  begin
...
begin
  ...
  with CL.AddClassN(CL.FindClass('TCustomChartSeries'),'TChartSeries') do
  begin
...
begin
  ...
  with CL.AddClassN(CL.FindClass('TOBJECT'),'TDataSourcesList') do
  begin
...
begin
  ...
  with CL.AddClassN(CL.FindClass('TOBJECT'),'TLabelsList') do
  begin
...
begin
  ...
  with CL.AddClassN(CL.FindClass('TOBJECT'),'TTeeSeriesType') do
  begin
...
begin
  ...
  with CL.AddClassN(CL.FindClass('TOBJECT'),'TChartValueLists') do
  begin
...
begin
  ...
  with CL.AddClassN(CL.FindClass('TComponent'),'TTeeFunction') do
  begin
    RegisterMethod('Constructor Create( AOwner : TComponent)');
    RegisterMethod('Procedure Assign( Source : TPersistent)');
...
begin
  ...
  with CL.AddClassN(CL.FindClass('TTeeCustomShape'),'TSeriesMarks') do
  begin
...
begin
  ...
  with CL.AddClassN(CL.FindClass('TOBJECT'),'TSeriesMarksSymbol') do
  begin
  end;
end;
...
begin
  ...
  with CL.AddClassN(CL.FindClass('TCallout'),'TMarksCallout') do
  begin
    RegisterMethod('Constructor Create( AOwner : TChartSeries)');
...
begin
  ...
  with CL.AddClassN(CL.FindClass('TSeriesPointer'),'TCallout') do
  begin
    RegisterMethod('Constructor Create( AOwner : TChartSeries)');
    RegisterMethod('Procedure Assign( Source : TPersistent)');
    RegisterProperty('Arrow', 'TChartArrowPen', iptrw);
...
begin
  ...
  with CL.AddClassN(CL.FindClass('TTeeCustomShapeBrushPen'),'TSeriesPointer') do
  begin
    RegisterMethod('Constructor Create( AOwner : TChartSeries)');
...
begin
  ...
  with CL.AddClassN(CL.FindClass('TOBJECT'),'TSeriesMarksGradient') do
  begin
...
begin
  ...
  with CL.AddClassN(CL.FindClass('TOBJECT'),'TMarksItems') do
  begin
...
begin
  ...
  with CL.AddClassN(CL.FindClass('TOBJECT'),'TMarksItem') do
  begin
...
begin
  ...
  with CL.AddClassN(CL.FindClass('TOBJECT'),'TSeriesMarksPositions') do
  begin
...
begin
  ...
  with CL.AddClassN(CL.FindClass('TOBJECT'),'TSeriesMarkPosition') do
  begin
...
begin
  ...
  with CL.AddClassN(CL.FindClass('TTeeEvent'),'TTeeSeriesEvent') do
  begin
...
begin
  ...
  with CL.AddClassN(CL.FindClass('TPersistent'),'TChartPage') do
  begin
...
begin
  ...
  with CL.AddClassN(CL.FindClass('TList'),'TChartTools') do
  begin
...
begin
  ...
  with CL.AddClassN(CL.FindClass('TObject'),'TTeeCustomDesigner') do
  begin
    RegisterMethod('Procedure Refresh');
...
begin
  ...
  with CL.AddClassN(CL.FindClass('TOBJECT'),'TChartCustomAxes') do
  begin
...
begin
  ...
  with CL.AddClassN(CL.FindClass('TOBJECT'),'TChartAxes') do
  begin
...
begin
  ...
  with CL.AddClassN(CL.FindClass('TOBJECT'),'TSeriesGroups') do
  begin
...
begin
  ...
  with CL.AddClassN(CL.FindClass('TOBJECT'),'TSeriesGroup') do
  begin
...
begin
  ...
  with CL.AddClassN(CL.FindClass('TOBJECT'),'TChartSeriesList') do
  begin
...
begin
  ...
  with CL.AddClassN(CL.FindClass('TList'),'TCustomSeriesList') do
  begin
...
begin
  ...
  with CL.AddClassN(CL.FindClass('TOBJECT'),'TSeriesEnumerator') do
  begin
...
begin
  ...
  with CL.AddClassN(CL.FindClass('TChartAxis'),'TChartDepthAxis') do
  begin
  end;
end;
...
begin
  ...
  with CL.AddClassN(CL.FindClass('TCollectionItem'),'TChartAxis') do
  begin
...
begin
  ...
  with CL.AddClassN(CL.FindClass('TOBJECT'),'TChartAxisPen') do
  begin
...
begin
  ...
  with CL.AddClassN(CL.FindClass('TOBJECT'),'TAxisItems') do
  begin
...
begin
  ...
  with CL.AddClassN(CL.FindClass('TTeeCustomShape'),'TAxisItem') do
  begin
    RegisterMethod('Procedure Repaint');
...
begin
  ...
  with CL.AddClassN(CL.FindClass('TOBJECT'),'TAxisGridPen') do
  begin
    RegisterMethod('Constructor Create( OnChangeEvent : TNotifyEvent)');
    RegisterMethod('Procedure Assign( Source : TPersistent)');
...
begin
  ...
  with CL.AddClassN(CL.FindClass('TOBJECT'),'TChartAxisTitle') do
  begin
...
begin
  ...
  with CL.AddClassN(CL.FindClass('TPersistent'),'TChartValueList') do
  begin
...
begin
  ...
  with CL.AddClassN(CL.FindClass('TComponent'),'TCustomChartElement') do
  begin
    RegisterMethod('Constructor Create( AOwner : TComponent)');
...
begin
 ...
 CL.AddConstantN('TeeDefaultLabelsSeparation','LongInt').SetInt( 10);
  CL.AddClassN(CL.FindClass('TOBJECT'),'TCustomAxisPanel');
  SIRegister_TCustomChartElement(CL);
  CL.AddClassN(CL.FindClass('TOBJECT'),'TCustomChartSeries');
  CL.AddClassN(CL.FindClass('TOBJECT'),'TChartSeries');
  ...
  CL.AddClassN(CL.FindClass('TOBJECT'),'TCustomSeriesList');
  ...
  SIRegister_TChartSeriesList(CL);
  ...
  CL.AddClassN(CL.FindClass('TOBJECT'),'TChartChangePage');
  ...
  CL.AddTypeS('TSeriesOnGetMarkText', 'Procedure ( Sender : TChartSeries; Value'
   +'Index : Integer; var MarkText : String)');
...
(*----------------------------------------------------------------------------*)
procedure TMarginsUnits_W(Self: TMargins; const T: TMarginUnits);
begin Self.Units := T; end;

(*----------------------------------------------------------------------------*)
procedure TMarginsUnits_R(Self: TMargins; var T: TMarginUnits);
begin T := Self.Units; end;

(*----------------------------------------------------------------------------*)
procedure TMarginsBottom_W(Self: TMargins; const T: Integer);
begin Self.Bottom := T; end;

(*----------------------------------------------------------------------------*)
procedure TMarginsBottom_R(Self: TMargins; var T: Integer);
begin T := Self.Bottom; end;

(*----------------------------------------------------------------------------*)
procedure TMarginsRight_W(Self: TMargins; const T: Integer);
begin Self.Right := T; end;

(*----------------------------------------------------------------------------*)
procedure TMarginsRight_R(Self: TMargins; var T: Integer);
begin T := Self.Right; end;

(*----------------------------------------------------------------------------*)
procedure TMarginsTop_W(Self: TMargins; const T: Integer);
begin Self.Top := T; end;

(*----------------------------------------------------------------------------*)
procedure TMarginsTop_R(Self: TMargins; var T: Integer);
begin T := Self.Top; end;

(*----------------------------------------------------------------------------*)
procedure TMarginsLeft_W(Self: TMargins; const T: Integer);
begin Self.Left := T; end;

(*----------------------------------------------------------------------------*)
procedure TMarginsLeft_R(Self: TMargins; var T: Integer);
begin T := Self.Left; end;

(*----------------------------------------------------------------------------*)
procedure TMarginsSize_R(Self: TMargins; var T: TRect);
...
procedure RIRegister_TChartValueLists(CL: TPSRuntimeClassImporter);
begin
  with CL.Add(TChartValueLists) do
  begin
...
begin
  ...
  begin
    RegisterConstructor(@TMargins.Create, 'Create');
    RegisterMethod(@TMargins.Assign, 'Assign');
    RegisterMethod(@TMargins.Calculate, 'Calculate');
    RegisterMethod(@TMargins.HorizSize, 'HorizSize');
    RegisterMethod(@TMargins.VertSize, 'VertSize');
...
begin
  with CL.Add(TChartValueList) do begin
    ...
    RegisterVirtualConstructor(@TChartValueList.Create, 'Create');
