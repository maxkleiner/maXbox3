...
procedure TAtomF.SetIsOperand(const Value: Boolean);
begin
  FIsOperand := Value;
end;

procedure TAtomF.SetToken(const Value: TToken);
begin
  FToken := Value;
end;

procedure TAtomF.SetProc(const Value: TProcVar);
begin
  FProc := Value;
end;

procedure TAtomF.SetSymbol(const Value: string);
begin
  FSymbol := Value;
end;

procedure TAtomF.SetValue(const Value: Variant);
begin
  FValue := Value;
end;
