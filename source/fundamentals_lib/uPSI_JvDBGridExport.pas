...
{
  another db grid export , less text export with JvgExport
}
interface
...
begin
  ...
  with CL.AddClassN(CL.FindClass('TJvComponent'),'TJvCustomDBGridExport') do begin
    RegisterMethod('Constructor Create( AOwner : TComponent)');
...
begin
  ...
  CL.AddTypeS('TExportSeparator', '( esTab, esSemiColon, esComma, esSpace, esPipe )');
...
procedure RIRegister_TJvDBGridHTMLExport(CL: TPSRuntimeClassImporter);
begin
  with CL.Add(TJvDBGridHTMLExport) do begin
...
procedure RIRegister_TJvCustomDBGridTextExport(CL: TPSRuntimeClassImporter);
begin
  with CL.Add(TJvCustomDBGridTextExport) do begin
...
procedure RIRegister_TJvDBGridExcelExport(CL: TPSRuntimeClassImporter);
begin
  with CL.Add(TJvDBGridExcelExport) do begin
...
procedure RIRegister_TJvDBGridWordExport(CL: TPSRuntimeClassImporter);
begin
  with CL.Add(TJvDBGridWordExport) do begin
...
procedure RIRegister_TJvCustomDBGridExport(CL: TPSRuntimeClassImporter);
begin
  with CL.Add(TJvCustomDBGridExport) do begin
