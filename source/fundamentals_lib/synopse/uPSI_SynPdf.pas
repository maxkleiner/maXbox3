...
begin
  ...
  with CL.AddClassN(CL.FindClass('TPdfObject'),'TPdfBinary') do
  begin
...
begin
  ...
  with CL.AddClassN(CL.FindClass('TPdfObject'),'TPdfText') do
  begin
...
begin
  ...
  with CL.AddClassN(CL.FindClass('TPdfObject'),'TPdfBoolean') do
  begin
...
begin
  ...
  with CL.AddClassN(CL.FindClass('TObject'),'TPdfObjectMgr') do
  begin
...
procedure RIRegister_TPdfDocumentGDI(CL: TPSRuntimeClassImporter);
begin
  with CL.Add(TPdfDocumentGDI) do
  begin
...
procedure RIRegister_TPdfDictionaryWrapper(CL: TPSRuntimeClassImporter);
begin
  with CL.Add(TPdfDictionaryWrapper) do
  begin
...
begin
  with CL.Add(TPdfPage) do begin
    RegisterVirtualConstructor(@TPdfPage.Create, 'Create');
...
procedure RIRegister_TPdfDictionaryElement(CL: TPSRuntimeClassImporter);
begin
  with CL.Add(TPdfDictionaryElement) do
  begin
...
begin
  with CL.Add(TPdfObject) do begin
    RegisterVirtualConstructor(@TPdfObject.Create, 'Create');
