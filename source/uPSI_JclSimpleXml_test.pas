...
begin
  ...
  with CL.AddClassN(CL.FindClass('TObject'),'TJclSimpleXML') do
  begin
...
begin
  ...
  with CL.AddClassN(CL.FindClass('TJclSimpleXMLElem'),'TJclSimpleXMLElemMSOApplication') do
  begin
  end;
end;
...
begin
  ...
  with CL.AddClassN(CL.FindClass('TJclSimpleXMLElem'),'TJclSimpleXMLElemSheet') do
  begin
  end;
end;
...
begin
  ...
  with CL.AddClassN(CL.FindClass('TJclSimpleXMLElem'),'TJclSimpleXMLElemDocType') do
  begin
  end;
end;
...
begin
  ...
  with CL.AddClassN(CL.FindClass('TJclSimpleXMLElem'),'TJclSimpleXMLElemHeader') do
  begin
...
begin
  ...
  with CL.AddClassN(CL.FindClass('TJclSimpleXMLElem'),'TJclSimpleXMLElemText') do
  begin
  end;
end;
...
begin
  ...
  with CL.AddClassN(CL.FindClass('TJclSimpleXMLElem'),'TJclSimpleXMLElemCData') do
  begin
  end;
end;
...
begin
  ...
  with CL.AddClassN(CL.FindClass('TJclSimpleXMLElem'),'TJclSimpleXMLElemClassic') do
  begin
  end;
end;
...
begin
  ...
  with CL.AddClassN(CL.FindClass('TJclSimpleXMLElem'),'TJclSimpleXMLElemComment') do
  begin
  end;
end;
...
begin
  ...
  with CL.AddClassN(CL.FindClass('TObject'),'TJclSimpleXMLElem') do
  begin
...
begin
  ...
  with CL.AddClassN(CL.FindClass('TObject'),'TJclSimpleXMLElems') do
  begin
    RegisterMethod('Constructor Create( const AOwner : TJclSimpleXMLElem)');
...
begin
  ...
  with CL.AddClassN(CL.FindClass('TObject'),'TJclSimpleXMLNamedElems') do
  begin
...
begin
  ...
  with CL.AddClassN(CL.FindClass('TObject'),'TJclSimpleXMLElemsProlog') do
  begin
    RegisterMethod('Constructor Create');
...
begin
  ...
  with CL.AddClassN(CL.FindClass('TObject'),'TJclSimpleXMLProps') do
  begin
...
begin
  ...
  with CL.AddClassN(CL.FindClass('TObject'),'TJclSimpleXMLProp') do
  begin
...
begin
  ...
  CL.AddTypeS('TJclOnSimpleXMLParsed', 'Procedure ( Sender : TObject; const Nam'
   +'e : string)');
  CL.AddTypeS('TJclOnValueParsed', 'Procedure ( Sender : TObject; const Name, V'
   +'alue : string)');
  ...
  CL.AddTypeS('TJclSimpleXMLElemCompare', 'Function ( Elems : TJclSimpleXMLElem'
   +'s; Index1, Index2 : Integer) : Integer');
  ...
  CL.AddTypeS('TJclSimpleXMLOptions', 'set of ( sxoAutoCreate, sxoAutoIndent, s'
   +'xoAutoEncodeValue, sxoAutoEncodeEntity, sxoDoNotSaveProlog, sxoTrimPrecedi'
   +'ngTextWhitespace )');
  CL.AddTypeS('TJclSimpleXMLEncodeEvent', 'Procedure ( Sender : TObject; var Va'
   +'lue : string)');
  CL.AddTypeS('TJclSimpleXMLEncodeStreamEvent', 'Procedure ( Sender : TObject; '
...
Begin Result := JclSimpleXml.XMLCreate; END;

(*----------------------------------------------------------------------------*)
Function XMLCreate_P( const AXML : TJclSimpleXMLElem) : Variant;
Begin Result := JclSimpleXml.XMLCreate(AXML); END;
...
(*----------------------------------------------------------------------------*)
procedure TJclSimpleXMLNamedElemsName_R(Self: TJclSimpleXMLNamedElems; var T: string);
begin T := Self.Name; end;

(*----------------------------------------------------------------------------*)
procedure TJclSimpleXMLNamedElemsCount_R(Self: TJclSimpleXMLNamedElems; var T: Integer);
begin T := Self.Count; end;

(*----------------------------------------------------------------------------*)
procedure TJclSimpleXMLNamedElemsItem_R(Self: TJclSimpleXMLNamedElems; var T: TJclSimpleXMLElem; const t1: Integer);
begin T := Self.Item[t1]; end;

(*----------------------------------------------------------------------------*)
procedure TJclSimpleXMLNamedElemsElems_R(Self: TJclSimpleXMLNamedElems; var T: TJclSimpleXMLElems);
begin T := Self.Elems; end;

(*----------------------------------------------------------------------------*)
Function TJclSimpleXMLNamedElemsIndexOf1_P(Self: TJclSimpleXMLNamedElems;  const Value : string) : Integer;
Begin Result := Self.IndexOf(Value); END;

(*----------------------------------------------------------------------------*)
Function TJclSimpleXMLNamedElemsIndexOf_P(Self: TJclSimpleXMLNamedElems;  const Value : TJclSimpleXMLElem) : Integer;
Begin Result := Self.IndexOf(Value); END;

(*----------------------------------------------------------------------------*)
Function TJclSimpleXMLNamedElemsAdd4_P(Self: TJclSimpleXMLNamedElems;  Value : TStream) : TJclSimpleXmlElemClassic;
Begin Result := Self.Add(Value); END;

(*----------------------------------------------------------------------------*)
Function TJclSimpleXMLNamedElemsAdd3_P(Self: TJclSimpleXMLNamedElems;  const Value : Boolean) : TJclSimpleXmlElemClassic;
Begin Result := Self.Add(Value); END;

(*----------------------------------------------------------------------------*)
Function TJclSimpleXMLNamedElemsAdd2_P(Self: TJclSimpleXMLNamedElems;  const Value : Int64) : TJclSimpleXmlElemClassic;
Begin Result := Self.Add(Value); END;

(*----------------------------------------------------------------------------*)
Function TJclSimpleXMLNamedElemsAdd1_P(Self: TJclSimpleXMLNamedElems;  const Value : string) : TJclSimpleXmlElemClassic;
Begin Result := Self.Add(Value); END;

(*----------------------------------------------------------------------------*)
Function TJclSimpleXMLNamedElemsAdd_P(Self: TJclSimpleXMLNamedElems) : TJclSimpleXmlElemClassic;
...
(*----------------------------------------------------------------------------*)
Function TJclSimpleXMLPropsAdd_P(Self: TJclSimpleXMLProps;  const Name, Value : string) : TJclSimpleXMLProp;
Begin Result := Self.Add(Name, Value); END;
...
begin
  ...
  begin
    RegisterVirtualConstructor(@TJclSimpleXMLElem.Create, 'Create');
...
procedure RIRegister_TJclSimpleXMLProp(CL: TPSRuntimeClassImporter);
begin
  with CL.Add(TJclSimpleXMLProp) do
  begin
