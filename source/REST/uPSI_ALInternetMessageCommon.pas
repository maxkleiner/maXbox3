...
begin
  ...
  with CL.AddClassN(CL.FindClass('Tpersistent'),'TALNewsArticleHeader') do
  begin
...
begin
  ...
  with CL.AddClassN(CL.FindClass('Tpersistent'),'TALEMailHeader') do
  begin
    RegisterMethod('Constructor Create');
    RegisterMethod('Procedure Clear');
    RegisterProperty('From', 'AnsiString', iptrw);
...
begin
 ...
 S.RegisterDelphiFunction(@AlGenerateInternetMessageID1, 'AlGenerateInternetMessageID1', cdRegister);
