...
begin
  ...
  with CL.AddClassN(CL.FindClass('Tobject'),'TAlTrivialWebSpider') do
  begin
...
begin
  ...
  with CL.AddClassN(CL.FindClass('TObject'),'TAlWebSpider') do
  begin
...
begin
  ...
  CL.AddTypeS('TAlWebSpiderUpdateLinkToLocalPathEndEvent', 'Procedure ( Sender '
   +': TObject)');
...
procedure RIRegister_TAlTrivialWebSpider(CL: TPSRuntimeClassImporter);
begin
  with CL.Add(TAlTrivialWebSpider) do
  begin
