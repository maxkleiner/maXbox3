...
begin
 ...
 S.RegisterDelphiFunction(@AlCGIInitDefaultServerVariablesFromWebRequest1, 'AlCGIInitDefaultServerVariablesFromWebRequest1', cdRegister);
 S.RegisterDelphiFunction(@ALCGIInitDefaultServerVariables, 'ALCGIInitDefaultServerVariables', cdRegister);
 S.RegisterDelphiFunction(@AlCGIInitDefaultServerVariables1, 'AlCGIInitDefaultServerVariables1', cdRegister);
 ...
 S.RegisterDelphiFunction(@AlCGIExec1, 'AlCGIExec1', cdRegister);
 S.RegisterDelphiFunction(@AlCGIExec2, 'AlCGIExec2', cdRegister);
end;
