...
begin
  ...
  with CL.AddClassN(CL.FindClass('TALFTPClient'),'TALWinInetFTPClient') do
  begin
...
begin
  ...
  CL.AddTypeS('TALWinInetFTPClientInternetOptionSet', 'set of TAlWinInetFTPClie'
   +'ntInternetOption');
  CL.AddTypeS('TAlWinInetFTPClientStatusChangeEvent', 'Procedure ( sender : Tob'
   +'ject; InternetStatus : DWord; StatusInformation : Pointer; StatusInformati'
   +'onLength : DWord)');
...
procedure RIRegister_TALWinInetFTPClient(CL: TPSRuntimeClassImporter);
begin
  with CL.Add(TALWinInetFTPClient) do
  begin
