...
begin
  ...
  with CL.AddClassN(CL.FindClass('TJclCustomMap'),'TJclBitmap32') do begin
    ...
    RegisterMethod('Procedure Clear');
    RegisterMethod('Procedure Clear( FillColor : TColor32)');
...
begin
  ...
  with CL.AddClassN(CL.FindClass('TCanvas'),'TJclDesktopCanvas') do
  begin
    RegisterMethod('Constructor Create');
    RegisterMethod('Procedure Free');
  end;
...
begin
  ...
  CL.AddTypeS('TConversionKind', '( ckRed, ckGreen, ckBlue, ckAlpha, ckUniformR'
   +'GB, ckWeightedRGB )');
