...
The Initial Developers of the Original Code are: FrÈdÈric Leneuf-Magaud
Copyright (c) 2004 FrÈdÈric Leneuf-Magaud
All Rights Reserved.
...
Known Issues:
-----------------------------------------------------------------------------}
// $Id: JvDBUltimGrid.pas 12461 2009-08-14 17:21:33Z obones $  mX4 only dbgrid
...
uses
  ...
  Windows, Variants, Classes, Graphics, Controls, DB, DBGrids,
...
function TJvDBUltimGrid.ChangeSortMarker(const Value: TSortMarker): Boolean;
begin
...
procedure TJvDBUltimGrid.SetSortMarker(const Value: TSortMarker);
begin
