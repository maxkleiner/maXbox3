...
begin
 ...
 CL.AddDelphiFunction('Function ALMimeBase64DecodePartial( const InputBuffer : TByteDynArray; InputOffset : NativeInt; const InputByteCount : NativeInt; out OutputBuffer : TByteDynArray; OutputOffset : NativeInt; var ByteBuffer : Cardinal; var ByteBufferSpace : Cardinal) : NativeInt;');
...
begin
 ...
 S.RegisterDelphiFunction(@ALMimeBase64EncodeNoCRLF, 'ALMimeBase64EncodeNoCRLF', cdRegister);
 S.RegisterDelphiFunction(@ALMimeBase64EncodeFullLines, 'ALMimeBase64EncodeFullLines', cdRegister);
 S.RegisterDelphiFunction(@ALMimeBase64Decode1, 'ALMimeBase64Decode1', cdRegister);
 S.RegisterDelphiFunction(@ALMimeBase64DecodePartial1, 'ALMimeBase64DecodePartial1', cdRegister);
 S.RegisterDelphiFunction(@ALMimeBase64DecodePartialEnd1, 'ALMimeBase64DecodePartialEnd1', cdRegister);
