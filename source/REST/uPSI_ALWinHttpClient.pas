...
begin
  ...
  with CL.AddClassN(CL.FindClass('TALHTTPClient'),'TALWinHttpClient') do
  begin
...
begin
  ...
  CL.AddTypeS('TALWinHttpClientInternetOptionSet', 'set of TALWinHttpClientInte'
   +'rnetOption');
  CL.AddTypeS('TALWinHttpClientStatusChangeEvent', 'Procedure ( sender : Tobjec'
   +'t; InternetStatus : DWord; StatusInformation : Pointer; StatusInformationL'
   +'ength : DWord)');
...
procedure RIRegister_TALWinHttpClient(CL: TPSRuntimeClassImporter);
begin
  with CL.Add(TALWinHttpClient) do
  begin
