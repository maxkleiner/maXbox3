...
(*----------------------------------------------------------------------------*)
Procedure TALHTTPClientDelete_P(Self: TALHTTPClient;  const aUrl : AnsiString; aResponseContentStream : TStream; aResponseContentHeader : TALHTTPResponseHeader);
Begin Self.Delete(aUrl, aResponseContentStream, aResponseContentHeader); END;

(*----------------------------------------------------------------------------*)
Procedure TALHTTPClientPut_P(Self: TALHTTPClient;  const aUrl : AnsiString; aPutDataStream : TStream; aResponseContentStream : TStream; aResponseContentHeader : TALHTTPResponseHeader);
Begin Self.Put(aUrl, aPutDataStream, aResponseContentStream, aResponseContentHeader); END;

(*----------------------------------------------------------------------------*)
Procedure TALHTTPClientTrace_P(Self: TALHTTPClient;  const aUrl : AnsiString; aResponseContentStream : TStream; aResponseContentHeader : TALHTTPResponseHeader);
Begin Self.Trace(aUrl, aResponseContentStream, aResponseContentHeader); END;

(*----------------------------------------------------------------------------*)
Procedure TALHTTPClientHead_P(Self: TALHTTPClient;  const aUrl : AnsiString; aResponseContentStream : TStream; aResponseContentHeader : TALHTTPResponseHeader);
Begin Self.Head(aUrl, aResponseContentStream, aResponseContentHeader); END;

(*----------------------------------------------------------------------------*)
Procedure TALHTTPClientPostMultipartFormData_P(Self: TALHTTPClient;  const aUrl : AnsiString; aPostDataStrings : TALStrings; aPostDataFiles : TALMultiPartFormDataContents; aResponseContentStream : TStream; aResponseContentHeader : TALHTTPResponseHeader);
Begin Self.PostMultipartFormData(aUrl, aPostDataStrings, aPostDataFiles, aResponseContentStream, aResponseContentHeader); END;

(*----------------------------------------------------------------------------*)
Procedure TALHTTPClientPostUrlEncoded_P(Self: TALHTTPClient;  const aUrl : AnsiString; aPostDataStrings : TALStrings; aResponseContentStream : TStream; aResponseContentHeader : TALHTTPResponseHeader; const EncodeParams : Boolean);
Begin Self.PostUrlEncoded(aUrl, aPostDataStrings, aResponseContentStream, aResponseContentHeader, EncodeParams); END;

(*----------------------------------------------------------------------------*)
Procedure TALHTTPClientPost1_P(Self: TALHTTPClient;  const aUrl : AnsiString; aPostDataStream : TStream; aResponseContentStream : TStream; aResponseContentHeader : TALHTTPResponseHeader);
Begin Self.Post(aUrl, aPostDataStream, aResponseContentStream, aResponseContentHeader); END;

(*----------------------------------------------------------------------------*)
Procedure TALHTTPClientPost_P(Self: TALHTTPClient;  const aUrl : AnsiString; aResponseContentStream : TStream; aResponseContentHeader : TALHTTPResponseHeader);
...
begin
  ...
  begin
    RegisterVirtualConstructor(@TALHTTPClient.Create, 'Create');
    RegisterVirtualMethod(@TALHTTPClient.Execute, 'Execute');
