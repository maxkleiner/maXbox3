...
begin
  ...
  with CL.AddInterface(CL.FindInterface('IXmlBase'),IXmlNode, 'IXmlDocument') do begin
...
procedure SIRegister_IXmlProcessingInstruction(CL: TPSPascalCompiler);
begin
  //with RegInterfaceS(CL,'IXmlNode', 'IXmlProcessingInstruction') do
  with CL.AddInterface(CL.FindInterface('IXmlNode'),IXmlProcessingInstruction, 'IXmlProcessingInstruction') do
  begin
  end;
end;
...
procedure SIRegister_IXmlCharacterData(CL: TPSPascalCompiler);
begin
  //with RegInterfaceS(CL,'IXmlNode', 'IXmlCharacterData') do
  with CL.AddInterface(CL.FindInterface('IXmlNode'),IXmlCharacterData, 'IXmlCharacterData') do
  begin
  end;
end;
...
procedure SIRegister_IXmlElement(CL: TPSPascalCompiler);
begin
  //with RegInterfaceS(CL,'IXmlNode', 'IXmlElement') do
  with CL.AddInterface(CL.FindInterface('IXmlNode'),IXmlElement, 'IXmlElement') do begin
...
begin
  ...
  with CL.AddInterface(CL.FindInterface('IXmlBase'),IXmlNode, 'IXmlNode') do begin
    ...
    RegisterMethod('Function CloneNode( aDeep : Boolean) : IXmlNode', cdRegister);
    RegisterMethod('Function Get_ParentNode : IXmlNode', cdRegister);
    RegisterMethod('Function Get_OwnerDocument : IXmlDocument', cdRegister);
    RegisterMethod('Function Get_ChildNodes : IXmlNodeList', cdRegister);
    RegisterMethod('Procedure AppendChild( const aChild : IXmlNode)', cdRegister);
    RegisterMethod('Procedure InsertBefore( const aChild, aBefore : IXmlNode)', cdRegister);
    RegisterMethod('Procedure ReplaceChild( const aNewChild, anOldChild : IXmlNode)', cdRegister);
    RegisterMethod('Procedure RemoveChild( const aChild : IXmlNode)', cdRegister);
    RegisterMethod('Procedure ExchangeChilds( const aChild1, aChild2 : IXmlNode)', cdRegister);
    ...
    RegisterMethod('Function NeedChild( aNameID : NativeInt) : IXmlNode;', cdRegister);
    RegisterMethod('Function NeedChild1( const aName : TXmlString) : IXmlNode;', cdRegister);
    RegisterMethod('Function EnsureChild( aNameID : NativeInt) : IXmlNode;', cdRegister);
    RegisterMethod('Function EnsureChild1( const aName : TXmlString) : IXmlNode;', cdRegister);
    RegisterMethod('Procedure RemoveAllChilds', cdRegister);
    RegisterMethod('Function SelectNodes( const anExpression : TXmlString) : IXmlNodeList', cdRegister);
    RegisterMethod('Function SelectSingleNode( const anExpression : TXmlString) : IXmlNode', cdRegister);
...
begin
  ...
  with CL.AddInterface(CL.FindInterface('IXmlBase'),IXmlNodeList, 'IXmlNodeList') do
  begin
    RegisterMethod('Function Get_Count : Integer', cdRegister);
    RegisterMethod('Function Get_Item( anIndex : Integer) : IXmlNode', cdRegister);
...
begin
 ...
 // SIRegister_IXmlCharacterData(CL);
  ...
  CL.AddTypeS('THookTag', 'Procedure ( Sender : TObject; aNode : IXmlNode)');
...
(*----------------------------------------------------------------------------*)
Function IXmlNodeNeedEnumAttr1_P(Self: IXmlNode;  aNameID : NativeInt; const aValues : array of TXmlString) : Integer;
Begin Result := Self.NeedEnumAttr(aNameID, aValues); END;

(*----------------------------------------------------------------------------*)
Function IXmlNodeNeedEnumAttr_P(Self: IXmlNode;  const aName : TXmlString; const aValues : array of TXmlString) : Integer;
Begin Result := Self.NeedEnumAttr(aName, aValues); END;

(*----------------------------------------------------------------------------*)
Function IXmlNodeGetEnumAttr1_P(Self: IXmlNode;  aNameID : NativeInt; const aValues : array of TXmlString; aDefault : Integer) : Integer;
Begin Result := Self.GetEnumAttr(aNameID, aValues, aDefault); END;

(*----------------------------------------------------------------------------*)
Function IXmlNodeGetEnumAttr_P(Self: IXmlNode;  const aName : TXmlString; const aValues : array of TXmlString; aDefault : Integer) : Integer;
Begin Result := Self.GetEnumAttr(aName, aValues, aDefault); END;

(*----------------------------------------------------------------------------*)
Procedure IXmlNodeSetHexAttr1_P(Self: IXmlNode;  aNameID : NativeInt; aValue : Integer; aDigits : Integer);
Begin Self.SetHexAttr(aNameID, aValue, aDigits); END;

(*----------------------------------------------------------------------------*)
Procedure IXmlNodeSetHexAttr_P(Self: IXmlNode;  const aName : TXmlString; aValue : Integer; aDigits : Integer);
Begin Self.SetHexAttr(aName, aValue, aDigits); END;

(*----------------------------------------------------------------------------*)
Function IXmlNodeGetHexAttr1_P(Self: IXmlNode;  aNameID : NativeInt; aDefault : Integer) : Integer;
Begin Result := Self.GetHexAttr(aNameID, aDefault); END;

(*----------------------------------------------------------------------------*)
Function IXmlNodeGetHexAttr_P(Self: IXmlNode;  const aName : TXmlString; aDefault : Integer) : Integer;
Begin Result := Self.GetHexAttr(aName, aDefault); END;

(*----------------------------------------------------------------------------*)
Procedure IXmlNodeSetFloatAttr1_P(Self: IXmlNode;  const aName : TXmlString; aValue : Double);
Begin Self.SetFloatAttr(aName, aValue); END;

(*----------------------------------------------------------------------------*)
Procedure IXmlNodeSetFloatAttr_P(Self: IXmlNode;  aNameID : NativeInt; aValue : Double);
Begin Self.SetFloatAttr(aNameID, aValue); END;

(*----------------------------------------------------------------------------*)
Function IXmlNodeGetFloatAttr1_P(Self: IXmlNode;  const aName : TXmlString; aDefault : Double) : Double;
Begin Result := Self.GetFloatAttr(aName, aDefault); END;

(*----------------------------------------------------------------------------*)
Function IXmlNodeGetFloatAttr_P(Self: IXmlNode;  aNameID : NativeInt; aDefault : Double) : Double;
Begin Result := Self.GetFloatAttr(aNameID, aDefault); END;

(*----------------------------------------------------------------------------*)
Procedure IXmlNodeSetDateTimeAttr1_P(Self: IXmlNode;  const aName : TXmlString; aValue : TDateTime);
Begin Self.SetDateTimeAttr(aName, aValue); END;

(*----------------------------------------------------------------------------*)
Procedure IXmlNodeSetDateTimeAttr_P(Self: IXmlNode;  aNameID : NativeInt; aValue : TDateTime);
Begin Self.SetDateTimeAttr(aNameID, aValue); END;

(*----------------------------------------------------------------------------*)
Function IXmlNodeGetDateTimeAttr1_P(Self: IXmlNode;  const aName : TXmlString; aDefault : TDateTime) : TDateTime;
Begin Result := Self.GetDateTimeAttr(aName, aDefault); END;

(*----------------------------------------------------------------------------*)
Function IXmlNodeGetDateTimeAttr_P(Self: IXmlNode;  aNameID : NativeInt; aDefault : TDateTime) : TDateTime;
Begin Result := Self.GetDateTimeAttr(aNameID, aDefault); END;

(*----------------------------------------------------------------------------*)
Procedure IXmlNodeSetIntAttr1_P(Self: IXmlNode;  const aName : TXmlString; aValue : Integer);
Begin Self.SetIntAttr(aName, aValue); END;

(*----------------------------------------------------------------------------*)
Procedure IXmlNodeSetIntAttr_P(Self: IXmlNode;  aNameID : NativeInt; aValue : Integer);
Begin Self.SetIntAttr(aNameID, aValue); END;

(*----------------------------------------------------------------------------*)
Function IXmlNodeGetIntAttr1_P(Self: IXmlNode;  const aName : TXmlString; aDefault : Integer) : Integer;
Begin Result := Self.GetIntAttr(aName, aDefault); END;

(*----------------------------------------------------------------------------*)
Function IXmlNodeGetIntAttr_P(Self: IXmlNode;  aNameID : NativeInt; aDefault : Integer) : Integer;
Begin Result := Self.GetIntAttr(aNameID, aDefault); END;

(*----------------------------------------------------------------------------*)
Procedure IXmlNodeSetBoolAttr1_P(Self: IXmlNode;  const aName : TXmlString; aValue : Boolean);
Begin Self.SetBoolAttr(aName, aValue); END;

(*----------------------------------------------------------------------------*)
Procedure IXmlNodeSetBoolAttr_P(Self: IXmlNode;  aNameID : NativeInt; aValue : Boolean);
Begin Self.SetBoolAttr(aNameID, aValue); END;

(*----------------------------------------------------------------------------*)
Function IXmlNodeGetBoolAttr1_P(Self: IXmlNode;  const aName : TXmlString; aDefault : Boolean) : Boolean;
Begin Result := Self.GetBoolAttr(aName, aDefault); END;

(*----------------------------------------------------------------------------*)
Function IXmlNodeGetBoolAttr_P(Self: IXmlNode;  aNameID : NativeInt; aDefault : Boolean) : Boolean;
Begin Result := Self.GetBoolAttr(aNameID, aDefault); END;

(*----------------------------------------------------------------------------*)
Function IXmlNodeGetBytesAttr1_P(Self: IXmlNode;  const aName : TXmlString; const aDefault : TBytes) : TBytes;
Begin Result := Self.GetBytesAttr(aName, aDefault); END;

(*----------------------------------------------------------------------------*)
Function IXmlNodeGetBytesAttr_P(Self: IXmlNode;  aNameID : NativeInt; const aDefault : TBytes) : TBytes;
Begin Result := Self.GetBytesAttr(aNameID, aDefault); END;

(*----------------------------------------------------------------------------*)
Procedure IXmlNodeSetAttr1_P(Self: IXmlNode;  const aName, aValue : TXmlString);
Begin Self.SetAttr(aName, aValue); END;

(*----------------------------------------------------------------------------*)
Procedure IXmlNodeSetAttr_P(Self: IXmlNode;  aNameID : NativeInt; const aValue : TXmlString);
Begin Self.SetAttr(aNameID, aValue); END;

(*----------------------------------------------------------------------------*)
Function IXmlNodeGetAttr1_P(Self: IXmlNode;  const aName : TXmlString; const aDefault : TXmlString) : TXmlString;
Begin Result := Self.GetAttr(aName, aDefault); END;

(*----------------------------------------------------------------------------*)
Function IXmlNodeGetAttr_P(Self: IXmlNode;  aNameID : NativeInt; const aDefault : TXmlString) : TXmlString;
Begin Result := Self.GetAttr(aNameID, aDefault); END;

(*----------------------------------------------------------------------------*)
Function IXmlNodeNeedAttr1_P(Self: IXmlNode;  const aName : TXmlString) : TXmlString;
Begin Result := Self.NeedAttr(aName); END;

(*----------------------------------------------------------------------------*)
Function IXmlNodeNeedAttr_P(Self: IXmlNode;  aNameID : NativeInt) : TXmlString;
Begin Result := Self.NeedAttr(aNameID); END;

(*----------------------------------------------------------------------------*)
Procedure IXmlNodeSetVarAttr1_P(Self: IXmlNode;  const aName : TXmlString; aValue : Variant);
Begin Self.SetVarAttr(aName, aValue); END;

(*----------------------------------------------------------------------------*)
Procedure IXmlNodeSetVarAttr_P(Self: IXmlNode;  aNameID : NativeInt; const aValue : Variant);
Begin Self.SetVarAttr(aNameID, aValue); END;

(*----------------------------------------------------------------------------*)
Function IXmlNodeGetVarAttr1_P(Self: IXmlNode;  const aName : TXmlString; const aDefault : Variant) : Variant;
Begin Result := Self.GetVarAttr(aName, aDefault); END;

(*----------------------------------------------------------------------------*)
Function IXmlNodeGetVarAttr_P(Self: IXmlNode;  aNameID : NativeInt; const aDefault : Variant) : Variant;
Begin Result := Self.GetVarAttr(aNameID, aDefault); END;

(*----------------------------------------------------------------------------*)
Function IXmlNodeGetAttrType1_P(Self: IXmlNode;  const aName : TXmlString) : Integer;
Begin Result := Self.GetAttrType(aName); END;

(*----------------------------------------------------------------------------*)
Function IXmlNodeGetAttrType_P(Self: IXmlNode;  aNameID : NativeInt) : Integer;
Begin Result := Self.GetAttrType(aNameID); END;

(*----------------------------------------------------------------------------*)
Function IXmlNodeAttrExists1_P(Self: IXmlNode;  const aName : TXmlString) : Boolean;
Begin Result := Self.AttrExists(aName); END;

(*----------------------------------------------------------------------------*)
Function IXmlNodeAttrExists_P(Self: IXmlNode;  aNameID : NativeInt) : Boolean;
Begin Result := Self.AttrExists(aNameID); END;

(*----------------------------------------------------------------------------*)
Procedure IXmlNodeRemoveAttr1_P(Self: IXmlNode;  aNameID : NativeInt);
Begin Self.RemoveAttr(aNameID); END;

(*----------------------------------------------------------------------------*)
Procedure IXmlNodeRemoveAttr_P(Self: IXmlNode;  const aName : TXmlString);
Begin Self.RemoveAttr(aName); END;

(*----------------------------------------------------------------------------*)
Function IXmlNodeEnsureChild1_P(Self: IXmlNode;  const aName : TXmlString) : IXmlNode;
Begin Result := Self.EnsureChild(aName); END;

(*----------------------------------------------------------------------------*)
Function IXmlNodeEnsureChild_P(Self: IXmlNode;  aNameID : NativeInt) : IXmlNode;
Begin Result := Self.EnsureChild(aNameID); END;

(*----------------------------------------------------------------------------*)
Function IXmlNodeNeedChild1_P(Self: IXmlNode;  const aName : TXmlString) : IXmlNode;
Begin Result := Self.NeedChild(aName); END;

(*----------------------------------------------------------------------------*)
Function IXmlNodeNeedChild_P(Self: IXmlNode;  aNameID : NativeInt) : IXmlNode;
Begin Result := Self.NeedChild(aNameID); END;

(*----------------------------------------------------------------------------*)
Procedure IXmlNodeSetChildText1_P(Self: IXmlNode;  aNameID : NativeInt; const aValue : TXmlString);
Begin Self.SetChildText(aNameID, aValue); END;

(*----------------------------------------------------------------------------*)
Procedure IXmlNodeSetChildText_P(Self: IXmlNode;  const aName, aValue : TXmlString);
Begin Self.SetChildText(aName, aValue); END;

(*----------------------------------------------------------------------------*)
Function IXmlNodeGetChildText1_P(Self: IXmlNode;  aNameID : NativeInt; const aDefault : TXmlString) : TXmlString;
Begin Result := Self.GetChildText(aNameID, aDefault); END;

(*----------------------------------------------------------------------------*)
Function IXmlNodeGetChildText_P(Self: IXmlNode;  const aName : TXmlString; const aDefault : TXmlString) : TXmlString;
Begin Result := Self.GetChildText(aName, aDefault); END;

(*----------------------------------------------------------------------------*)
Function IXmlNodeAppendProcessingInstruction1_P(Self: IXmlNode;  const aTarget : TXmlString; const aData : TXmlString) : IXmlProcessingInstruction;
Begin Result := Self.AppendProcessingInstruction(aTarget, aData); END;

(*----------------------------------------------------------------------------*)
Function IXmlNodeAppendProcessingInstruction_P(Self: IXmlNode;  aTargetID : NativeInt; const aData : TXmlString) : IXmlProcessingInstruction;
Begin Result := Self.AppendProcessingInstruction(aTargetID, aData); END;

(*----------------------------------------------------------------------------*)
Function IXmlNodeAppendElement1_P(Self: IXmlNode;  const aName : TxmlString) : IXmlElement;
Begin Result := Self.AppendElement(aName); END;

(*----------------------------------------------------------------------------*)
Function IXmlNodeAppendElement_P(Self: IXmlNode;  aNameID : NativeInt) : IXmlElement;
