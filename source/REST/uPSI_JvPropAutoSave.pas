...
begin
  ...
  with CL.AddClassN(CL.FindClass('TPersistent'),'TJvAutoSave') do
  begin
    ...
    RegisterMethod('Function LoadValue4( var Default : Integer) : Boolean;');
    RegisterMethod('Function LoadValue5( var Default : Double) : Boolean;');
    RegisterMethod('Function LoadValue6( var Default : Boolean) : Boolean;');
    RegisterMethod('Function LoadValue7( var Default : string) : Boolean;');
...
begin
  ...
  with CL.AddClassN(CL.FindClass('TPersistent'),'TJvRegAutoSave') do
  begin
...
begin
  ...
  begin
    ...
    RegisterMethod(@TJvAutoSaveLoadValue4_P, 'LoadValue4');
    RegisterMethod(@TJvAutoSaveLoadValue5_P, 'LoadValue5');
    RegisterMethod(@TJvAutoSaveLoadValue6_P, 'LoadValue6');
    RegisterMethod(@TJvAutoSaveLoadValue7_P, 'LoadValue7');
