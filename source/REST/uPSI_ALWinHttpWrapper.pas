...
begin
  ...
  CL.AddTypeS('WINHTTP_CURRENT_USER_IE_PROXY_CONFIG', 'record fAutoDetect : BOO'
   +'L; lpszAutoConfigUrl : LPWSTR; lpszProxy : LPWSTR; lpszProxyBypass : LPWST'
   +'R; end');
  CL.AddTypeS('TWINHTTP_CURRENT_USER_IE_PROXY_CONFIG', 'WINHTTP_CURRENT_USER_IE'
   +'_PROXY_CONFIG');
  CL.AddTypeS('LPWINHTTP_CURRENT_USER_IE_PROXY_CONFIG', 'PWINHTTP_CURRENT_USER_'
   +'IE_PROXY_CONFIG');
 ...
 CL.AddConstantN('WINHTTP_FLAG_REFRESH','').SetString( WINHTTP_FLAG_BYPASS_PROXY_CACHE);
 ...
 CL.AddConstantN('WINHTTP_NO_PROXY_NAME','LongInt').SetInt();
 CL.AddConstantN('WINHTTP_NO_PROXY_BYPASS','LongInt').SetInt();
 CL.AddConstantN('WINHTTP_OPTION_CALLBACK','LongInt').SetInt( 1);
 CL.AddConstantN('WINHTTP_FIRST_OPTION','').SetString( WINHTTP_OPTION_CALLBACK);
 ...
 CL.AddConstantN('WINHTTP_LAST_OPTION','').SetString( WINHTTP_OPTION_MAX_RESPONSE_DRAIN_SIZE);
 ...
 CL.AddConstantN('WINHTTP_AUTOLOGON_SECURITY_LEVEL_DEFAULT','').SetString( WINHTTP_AUTOLOGON_SECURITY_LEVEL_MEDIUM);
 ...
 CL.AddConstantN('WINHTTP_OPTION_REDIRECT_POLICY_LAST','').SetString( WINHTTP_OPTION_REDIRECT_POLICY_ALWAYS);
 CL.AddConstantN('WINHTTP_OPTION_REDIRECT_POLICY_DEFAULT','').SetString( WINHTTP_OPTION_REDIRECT_POLICY_DISALLOW_HTTPS_TO_HTTP);
 ...
 CL.AddConstantN('WINHTTP_CALLBACK_FLAG_DETECTING_PROXY','').SetString( WINHTTP_CALLBACK_STATUS_DETECTING_PROXY);
 CL.AddConstantN('WINHTTP_CALLBACK_FLAG_REDIRECT','').SetString( WINHTTP_CALLBACK_STATUS_REDIRECT);
 CL.AddConstantN('WINHTTP_CALLBACK_FLAG_INTERMEDIATE_RESPONSE','').SetString( WINHTTP_CALLBACK_STATUS_INTERMEDIATE_RESPONSE);
 CL.AddConstantN('WINHTTP_CALLBACK_FLAG_SECURE_FAILURE','').SetString( WINHTTP_CALLBACK_STATUS_SECURE_FAILURE);
 CL.AddConstantN('WINHTTP_CALLBACK_FLAG_SENDREQUEST_COMPLETE','').SetString( WINHTTP_CALLBACK_STATUS_SENDREQUEST_COMPLETE);
 CL.AddConstantN('WINHTTP_CALLBACK_FLAG_HEADERS_AVAILABLE','').SetString( WINHTTP_CALLBACK_STATUS_HEADERS_AVAILABLE);
 CL.AddConstantN('WINHTTP_CALLBACK_FLAG_DATA_AVAILABLE','').SetString( WINHTTP_CALLBACK_STATUS_DATA_AVAILABLE);
 CL.AddConstantN('WINHTTP_CALLBACK_FLAG_READ_COMPLETE','').SetString( WINHTTP_CALLBACK_STATUS_READ_COMPLETE);
 CL.AddConstantN('WINHTTP_CALLBACK_FLAG_WRITE_COMPLETE','').SetString( WINHTTP_CALLBACK_STATUS_WRITE_COMPLETE);
 CL.AddConstantN('WINHTTP_CALLBACK_FLAG_REQUEST_ERROR','').SetString( WINHTTP_CALLBACK_STATUS_REQUEST_ERROR);
 ...
 CL.AddConstantN('HTTP_STATUS_FIRST','').SetString( HTTP_STATUS_CONTINUE);
 CL.AddConstantN('HTTP_STATUS_LAST','').SetString( HTTP_STATUS_VERSION_NOT_SUP);
 CL.AddConstantN('WINHTTP_NO_REFERER','').SetString();
 CL.AddConstantN('WINHTTP_DEFAULT_ACCEPT_TYPES','').SetString();
 ...
 CL.AddConstantN('WINHTTP_ADDREQ_FLAG_COALESCE','').SetString( WINHTTP_ADDREQ_FLAG_COALESCE_WITH_COMMA);
 CL.AddConstantN('WINHTTP_ADDREQ_FLAG_REPLACE','LongWord').SetUInt( $80000000);
 CL.AddConstantN('WINHTTP_NO_ADDITIONAL_HEADERS','LongWord').SetUInt();
 CL.AddConstantN('WINHTTP_NO_REQUEST_DATA','LongWord').SetUInt();
 CL.AddConstantN('WINHTTP_HEADER_NAME_BY_INDEX','LongWord').SetUInt();
 CL.AddConstantN('WINHTTP_NO_OUTPUT_BUFFER','LongWord').SetUInt();
 CL.AddConstantN('WINHTTP_NO_HEADER_INDEX','LongWord').SetUInt();
 ...
 CL.AddDelphiFunction('Function WinHttpQueryOption( hInet : HINTERNET; dwOption : DWORD; lpBuffer : Pointer; var lpdwBufferLength : DWORD) : BOOL');
 CL.AddDelphiFunction('Function WinHttpSetOption( hInet : HINTERNET; dwOption : DWORD; lpBuffer : Pointer; dwBufferLength : DWORD) : BOOL');
 ...
 CL.AddDelphiFunction('Function WinHttpReceiveResponse( hRequest : HINTERNET; lpReserved : Pointer) : BOOL');
 CL.AddDelphiFunction('Function WinHttpQueryHeaders( hRequest : HINTERNET; dwInfoLevel : DWORD; pwszName : PWideChar; lpBuffer : Pointer; var lpdwBufferLength : DWORD; lpdwIndex : Pointer) : BOOL');
 CL.AddDelphiFunction('Function WinHttpQueryDataAvailable( hRequest : HINTERNET; var lpdwNumberOfBytesAvailable : DWORD) : BOOL');
 CL.AddDelphiFunction('Function WinHttpReadData( hRequest : HINTERNET; lpBuffer : Pointer; dwNumberOfBytesToRead : DWORD; var lpdwNumberOfBytesRead : DWORD) : BOOL');
 CL.AddDelphiFunction('Function WinHttpCloseHandle( hInternet : HINTERNET) : BOOL');
  ...
  CL.AddTypeS('PFNWinHttpStatusCallback', '^TFNWinHttpStatusCallback // will no'
   +'t work');
