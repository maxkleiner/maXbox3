...
begin
  ...
  with CL.AddClassN(CL.FindClass('TJclBorRADToolInstallationObject'),'TJclBorRADToolRepository') do
  begin
...
begin
  ...
  with CL.AddClassN(CL.FindClass('TJclBorRADToolInstallationObject'),'TJclBorRADToolPalette') do
  begin
...
begin
  ...
  CL.AddTypeS('TJclBorRADToolKind', '( brDelphi, brCppBuilder, brBorlandDevStud'
   +'io )');
 ...
 CL.AddConstantN('DOFOptionsKey','String').SetString( 'Options');
  ...
  CL.AddTypeS('TCommandLineTool', '( clAsm, clBcc32, clDcc32, clDccIL, clMake, '
   +'clProj2Mak )');
  ...
  CL.AddTypeS('TTraverseMethod', 'Function ( Installation : TJclBorRADToolInsta'
   +'llation) : Boolean');
 ...
 CL.AddDelphiFunction('Procedure GetDPRFileInfo( const DPRFileName : string; out BinaryExtension : string; const LibSuffix : PString)');
 CL.AddDelphiFunction('Procedure GetBPRFileInfo( const BPRFileName : string; out BinaryFileName : string; const Description : PString)');
 CL.AddDelphiFunction('Procedure GetDPKFileInfo( const DPKFileName : string; out RunOnly : Boolean; const LibSuffix : PString; const Description : PString)');
 CL.AddDelphiFunction('Procedure GetBPKFileInfo( const BPKFileName : string; out RunOnly : Boolean; const BinaryFileName : PString; const Description : PString)');
end;
...
Begin Result := Self.CompileDelphiPackage(PackageName, BPLPath, DCPPath, ExtraOptions); END;
...
Begin Result := Self.CompileDelphiPackage(PackageName, BPLPath, DCPPath); END;
...
(*----------------------------------------------------------------------------*)
procedure TJclHelp2ManagerHxRegister_R(Self: TJclHelp2Manager; var T: IHxRegister);
begin T := Self.HxRegister; end;
...
Begin Result := TJclHelp2Manager.Create(AInstallation); END;
...
procedure RIRegister_TJclBorRADToolRepository(CL: TPSRuntimeClassImporter);
begin
  with CL.Add(TJclBorRADToolRepository) do
  begin
...
procedure RIRegister_TJclCommandLineTool(CL: TPSRuntimeClassImporter);
begin
  with CL.Add(TJclCommandLineTool) do
  begin
  end;
end;
