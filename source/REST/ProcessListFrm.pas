...
begin
  Caption:= 'Attach Process List'; //Lang[ID_ITEM_ATTACHPROCESS];
  MainLabel.Caption:= 'Process to Attach';//'Lang[ID_MSG_ATTACH]';
  MainLabel.Width := 360;
  OKBtn.Caption:= 'OK'; //Lang[ID_BTN_OK];
  CancelBtn.Caption:= 'Cancel'; //Lang[ID_BTN_CANCEL];
  //ProcessCombo.ItemIndex:= 1;
end;
