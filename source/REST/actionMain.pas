...
procedure TActionForm.FileOpen1Accept(Sender: TObject);
begin
...
procedure TActionForm.ColorSelect1Accept(Sender: TObject);
begin
  Color := ColorSelect1.Dialog.Color;
end;

procedure TActionForm.OpenPicture1Accept(Sender: TObject);
begin
  Image1.Picture.LoadFromFile(OpenPicture1.Dialog.FileName);
end;

procedure TActionForm.FontEdit1Accept(Sender: TObject);
begin
  Font.Assign(FontEdit1.Dialog.Font);
end;

procedure TActionForm.DeleteActionExecute(Sender: TObject);
begin
  StaticListAction1.Items.Delete(StrToInt(DelEdit.Text));
end;

procedure TActionForm.AddActionExecute(Sender: TObject);
begin
  with StaticListAction1.Items.Add do
    Caption := AddEdit.Text;
end;

procedure TActionForm.ClearActionExecute(Sender: TObject);
begin
  StaticListAction1.Items.Clear;
end;

procedure TActionForm.ActiveActionExecute(Sender: TObject);
begin
...
procedure TActionForm.SetIndexActionExecute(Sender: TObject);
begin
  StaticListAction1.ItemIndex := StrToInt(IdxEdit.Text);
end;

procedure TActionForm.ShortCutActionExecute(Sender: TObject);
begin
  ShowMessage('ShortCut action executed');
end;

procedure TActionForm.UpdateShortCutList;
var
  I: Integer;
begin
...
procedure TActionForm.AddShortCutExecute(Sender: TObject);
begin
  ShortCutAction.SecondaryShortCuts.Add(ShortCutToText(HotKey1.HotKey));
  UpdateShortCutList;
end;

procedure TActionForm.FileSaveAs1Accept(Sender: TObject);
begin
  Memo1.Lines.SaveToFile(FileSaveAs1.Dialog.FileName);
end;

procedure TActionForm.SearchTabShow(Sender: TObject);
begin
  Memo2.SetFocus;
end;

procedure TActionForm.EditTabShow(Sender: TObject);
begin
  Memo3.SetFocus;
end;
