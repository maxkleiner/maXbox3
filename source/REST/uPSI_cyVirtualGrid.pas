...
begin
  ...
  with CL.AddClassN(CL.FindClass('TComponent'),'TcyVirtualGrid') do
  begin
...
begin
  ...
  CL.AddTypeS('TProcGeneratedCell', 'Procedure ( Sender : TObject; Rect : TRect'
   +'; CoordX, CoordY : Integer)');
  CL.AddTypeS('TProcRowSize', 'Procedure ( Sender : TObject; CoordY : Integer; '
   +'var Size : Word)');
  CL.AddTypeS('TProcColumnSize', 'Procedure ( Sender : TObject; CoordX : Intege'
   +'r; var Size : Word)');
