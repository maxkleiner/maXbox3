...
//  end;
  ...
  begin
    ...
    value := StrToInt64(DecodeStringA(Code, Index));
  end;
  ...
  begin
    ...
    value := StrToFloat(DecodeStringA(Code, Index), ALDefaultFormatSettings);
  end;
  ...
  begin
    ...
    value := StrToInt(DecodeStringA(Code, Index));
  end;
  ...
  begin
    ...
    value := StrToDateTime(DecodeStringA(Code, Index), ALDefaultFormatSettings);
  end;
  ...
  begin
    ...
    value := StrToCurr(DecodeStringA(Code, Index), ALDefaultFormatSettings);
  end;
  ...
  begin
    ...
    value := StrToInt(DecodeStringA(Code, Index)) <> 0;
  end;
  ...
  begin
    ...
    Value := Trunc(StrToDate(DecodeStringA(Code, Index), ALDefaultFormatSettings));
  end;
...
//  end;
  ...
  begin
    ...
    begin
      ...
      begin
        case ASQLCode of
          SQL_SHORT  : Result := FormatFloat(cALFBXScaleFormat[sqlscale], PSmallInt(sqldata)^ / cALFBXScaleDivisor[sqlscale], ALDefaultFormatSettings);
          SQL_LONG   : Result := FormatFloat(cALFBXScaleFormat[sqlscale], PInteger(sqldata)^  / cALFBXScaleDivisor[sqlscale], ALDefaultFormatSettings);
          SQL_INT64,
          SQL_QUAD   : Result := FormatFloat(cALFBXScaleFormat[sqlscale], PInt64(sqldata)^    / cALFBXScaleDivisor[sqlscale], ALDefaultFormatSettings);
          SQL_D_FLOAT,
          SQL_DOUBLE : Result := FormatFloat(cALFBXScaleFormat[sqlscale], PDouble(sqldata)^, ALDefaultFormatSettings);
        else
          raise EALFBXConvertError.Create(cALFBX_UNEXPECTEDERROR);
        end;
      end else
        case ASQLCode of
          ...
          SQL_TIMESTAMP : Result := DateTimeToStr(ALFBXDecodeTimeStamp(PISCTimeStamp(sqldata)), ALDefaultFormatSettings);
          SQL_TYPE_DATE : Result := DateToStr(PInteger(sqldata)^ - cAlFBXDateOffset, ALDefaultFormatSettings);
          SQL_TYPE_TIME : Result := TimeToStr(PCardinal(sqldata)^ / cALFBXTimeCoeff, ALDefaultFormatSettings);
          SQL_D_FLOAT,
          SQL_DOUBLE    : Result := FloatToStr(PDouble(sqldata)^, ALDefaultFormatSettings);
          SQL_LONG      : Result := IntToStr(PInteger(sqldata)^);
          SQL_FLOAT     : Result := FloatToStr(PSingle(sqldata)^, ALDefaultFormatSettings);
    ...
    begin
      ...
      begin
        ...
        case ASQLCode of
          ...
          SQL_TEXT      : EncodeStringA(SQL_TEXT, Index, DateTimeToStr(Value, ALDefaultFormatSettings));
          SQL_VARYING   : EncodeStringA(SQL_VARYING, Index, DateTimeToStr(Value, ALDefaultFormatSettings));
{FB25_UP}
          SQL_NULL: ;
{FB25_UP}
        else
    ...
    begin
      ...
      begin
        ...
        case ASQLCode of
          ...
          SQL_TEXT      : EncodeStringA(SQL_TEXT, Index, DateToStr(Value, ALDefaultFormatSettings));
          SQL_VARYING   : EncodeStringA(SQL_VARYING, Index, DateToStr(Value, ALDefaultFormatSettings));
{FB25_UP}
          SQL_NULL: ;
{FB25_UP}
        else
    ...
    begin
      ...
      begin
        ...
        case ASQLCode of
          ...
          SQL_TEXT      : EncodeStringA(SQL_TEXT, Index, TimeToStr(Value, ALDefaultFormatSettings));
          SQL_VARYING   : EncodeStringA(SQL_VARYING, Index, TimeToStr(Value, ALDefaultFormatSettings));
{FB25_UP}
          SQL_NULL: ;
{FB25_UP}
        else
    ...
    begin
      ...
      begin
        ...
        case ASQLCode of
          ...
          SQL_TEXT      : EncodeStringA(SQL_TEXT, Index, IntToStr(ord(Value)));
          SQL_VARYING   : EncodeStringA(SQL_VARYING, Index, IntToStr(ord(Value)));
{FB25_UP}
          SQL_NULL: ;
{FB25_UP}
        else
    ...
    begin
      ...
      begin
        ...
        case ASQLCode of
          ...
          SQL_TEXT      : EncodeStringA(SQL_TEXT, Index, IntToStr(Value));
          SQL_VARYING   : EncodeStringA(SQL_VARYING, Index, IntToStr(Value));
{FB25_UP}
          SQL_NULL: ;
{FB25_UP}
        else
    ...
    begin
      ...
      begin
        ...
        case ASQLCode of
          ...
          SQL_TEXT      : EncodeStringA(SQL_TEXT, Index, FloatToStr(Value, ALDefaultFormatSettings));
          SQL_VARYING   : EncodeStringA(SQL_VARYING, Index, FloatToStr(Value, ALDefaultFormatSettings));
{FB25_UP}
          SQL_NULL: ;
{FB25_UP}
        else
...
//  end;
  ...
  begin
    ...
    begin
      ...
      begin
        case ASQLCode of
          SQL_SHORT  : PSmallInt(sqldata)^ := Trunc(StrToFloat(Value, ALDefaultFormatSettings) * cALFBXScaleDivisor[sqlscale]);
          SQL_LONG   : PInteger(sqldata)^  := Trunc(StrToFloat(Value, ALDefaultFormatSettings) * cALFBXScaleDivisor[sqlscale]);
          SQL_INT64,
          SQL_QUAD   : PInt64(sqldata)^    := Trunc(StrToFloat(Value, ALDefaultFormatSettings) * cALFBXScaleDivisor[sqlscale]);
          SQL_D_FLOAT,
          SQL_DOUBLE : PDouble(sqldata)^   := StrToFloat(Value, ALDefaultFormatSettings);
        else
          raise EALFBXConvertError.Create(cALFBX_UNEXPECTEDERROR);
        end;
      end else
        case ASQLCode of
          ...
          SQL_D_FLOAT,
          SQL_DOUBLE    : PDouble(sqldata)^   := StrToFloat(Value, ALDefaultFormatSettings);
          SQL_TIMESTAMP : ALFBXEncodeTimeStamp(StrToDateTime(Value, ALDefaultFormatSettings), PISCTimeStamp(sqldata));
          SQL_TYPE_DATE : PInteger(sqldata)^ := Round(int(StrToDate(Value, ALDefaultFormatSettings)) + cAlFBXDateOffset);
          SQL_TYPE_TIME : PCardinal(sqldata)^ := Round(Frac(StrToTime(Value, ALDefaultFormatSettings)) * cALFBXTimeCoeff);
          SQL_LONG      : PInteger(sqldata)^ := StrToInt(Value);
          SQL_FLOAT     : PSingle(sqldata)^ := StrToFloat(Value, ALDefaultFormatSettings);
