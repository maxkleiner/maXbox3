...
begin
  ...
  with CL.AddClassN(CL.FindClass('TIdBaseComponent'),'TIdUserManager') do
  begin
...
begin
  ...
  begin
    RegisterMethod(@TIdUserManager.AuthenticateUser, 'AuthenticateUser');
    RegisterConstructor(@TIdUserManager.Create, 'Create');
