...
begin
  ...
  with CL.AddClassN(CL.FindClass('TBaseVectorList'),'TQuaternionList') do
  begin
...
begin
  ...
  begin
    ...
    RegisterMethod('Procedure Add2( const list : TIntegerList);');
    ...
    RegisterMethod('Procedure AddIntegers1( const aList : TIntegerList);');
...
begin
  ...
  with CL.AddClassN(CL.FindClass('TBaseList'),'TTexPointList') do
  begin
    RegisterMethod('Constructor Create');
    RegisterMethod('Procedure Assign( Src : TPersistent)');
...
begin
  ...
  with CL.AddClassN(CL.FindClass('TBaseVectorList'),'TVectorList') do
  begin
    RegisterMethod('Constructor Create');
    RegisterMethod('Procedure Assign( Src : TPersistent)');
...
begin
  ...
  with CL.AddClassN(CL.FindClass('TBaseVectorList'),'TAffineVectorList') do
  begin
    RegisterMethod('Constructor Create');
    RegisterMethod('Procedure Assign( Src : TPersistent)');
...
begin
  ...
  with CL.AddClassN(CL.FindClass('TBaseList'),'TBaseVectorList') do
  begin
...
(*----------------------------------------------------------------------------*)
Procedure TIntegerListOffset1_P(Self: TIntegerList;  delta : Integer; const base, nb : Integer);
Begin Self.Offset(delta, base, nb); END;

(*----------------------------------------------------------------------------*)
Procedure TIntegerListOffset_P(Self: TIntegerList;  delta : Integer);
Begin Self.Offset(delta); END;

(*----------------------------------------------------------------------------*)
Function TIntegerListBinarySearch1_P(Self: TIntegerList;  const value : Integer; returnBestFit : Boolean; var found : Boolean) : Integer;
Begin Result := Self.BinarySearch(value, returnBestFit, found); END;

(*----------------------------------------------------------------------------*)
Function TIntegerListBinarySearch_P(Self: TIntegerList;  const value : Integer) : Integer;
Begin Result := Self.BinarySearch(value); END;

(*----------------------------------------------------------------------------*)
Procedure TIntegerListAddIntegers2_P(Self: TIntegerList;  const anArray : array of Integer);
Begin Self.AddIntegers(anArray); END;

(*----------------------------------------------------------------------------*)
Procedure TIntegerListAddIntegers1_P(Self: TIntegerList;  const aList : TIntegerList);
Begin Self.AddIntegers(aList); END;

(*----------------------------------------------------------------------------*)
Procedure TIntegerListAddIntegers_P(Self: TIntegerList;  const first : PInteger; n : Integer);
...
(*----------------------------------------------------------------------------*)
Procedure TIntegerListAdd2_P(Self: TIntegerList;  const list : TIntegerList);
Begin Self.Add(list); END;

(*----------------------------------------------------------------------------*)
Procedure TIntegerListAdd1_P(Self: TIntegerList;  const i1, i2, i3 : Integer);
Begin Self.Add(i1, i2, i3); END;

(*----------------------------------------------------------------------------*)
Procedure TIntegerListAdd_P(Self: TIntegerList;  const i1, i2 : Integer);
Begin Self.Add(i1, i2); END;

(*----------------------------------------------------------------------------*)
Function TIntegerListAddNC_P(Self: TIntegerList;  const item : Integer) : Integer;
Begin Result := Self.AddNC(item); END;

(*----------------------------------------------------------------------------*)
Function TIntegerListAdd_P(Self: TIntegerList;  const item : Integer) : Integer;
Begin Result := Self.Add(item); END;
...
(*----------------------------------------------------------------------------*)
Function TTexPointListAddNC_P(Self: TTexPointList;  const texS, texT : Integer) : Integer;
...
(*----------------------------------------------------------------------------*)
Function TTexPointListAdd_P(Self: TTexPointList;  const item : TTexPoint) : Integer;
Begin Result := Self.Add(item); END;
...
(*----------------------------------------------------------------------------*)
Function TAffineVectorListAdd_P(Self: TAffineVectorList;  const xy : PIntegerArray; const z : Integer) : Integer;
Begin Result := Self.Add(xy, z); END;

(*----------------------------------------------------------------------------*)
Function TAffineVectorListAddNC_P(Self: TAffineVectorList;  const x, y, z : Integer) : Integer;
...
(*----------------------------------------------------------------------------*)
Function TAffineVectorListAdd_P(Self: TAffineVectorList;  const item : TAffineVector) : Integer;
Begin Result := Self.Add(item); END;
...
begin
 ...
 S.RegisterDelphiFunction(@QuickSortLists1, 'QuickSortLists1', cdRegister);
...
procedure RIRegister_TQuaternionList(CL: TPSRuntimeClassImporter);
begin
  with CL.Add(TQuaternionList) do
  begin
...
begin
  ...
  begin
    ...
    RegisterMethod(@TIntegerList.Assign, 'Assign');
...
procedure RIRegister_TAffineVectorList(CL: TPSRuntimeClassImporter);
begin
  with CL.Add(TAffineVectorList) do
  begin
...
procedure RIRegister_TBaseVectorList(CL: TPSRuntimeClassImporter);
begin
  with CL.Add(TBaseVectorList) do
  begin
