...
begin
  ...
  with CL.AddClassN(CL.FindClass('TGraphic'),'TOleGraphic') do begin
...
begin
  ...
  begin
    ...
    RegisterMethod('Function Invoke( DispID : Integer; const IID : TGUID; LocaleID : Integer; Flags : Word; var Params, VarResult, ExcepInfo, ArgErr : Pointer) : HResult');
...
begin
  ...
  begin
    RegisterMethod('Constructor Create( ComServer : TComServerObject; ActiveXControlClass : TActiveXControlClass; WinControlClass : TWinControlClass; const ClassID : TGUID; ToolboxBitmapID : Integer; const LicStr : string;'+
    ' MiscStatus : Integer; ThreadingModel : TThreadingModel)');
...
begin
  ...
  begin
    ...
    RegisterMethod(@TActiveXPropertyPageFactory.CreateComObject, 'CreateComObject');
  end;
end;
...
begin
  ...
  begin
    RegisterMethod(@TActiveXPropertyPage.Initialize, 'Initialize');
...
begin
  ...
  begin
    RegisterMethod(@TActiveFormFactory.GetIntfEntry, 'GetIntfEntry');
  end;
end;
...
begin
  ...
  begin
    ...
    RegisterMethod(@TActiveFormControl.Invoke, 'Invoke');
