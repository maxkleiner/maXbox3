...
begin
  ...
  with CL.AddClassN(CL.FindClass('TOBJECT'),'TPJPipeFilter') do
  begin
...
begin
  ...
  CL.AddTypeS('TPJUnicodeTextReadEvent', 'Procedure ( Sender : TObject; const T'
   +'ext : UnicodeString)');
