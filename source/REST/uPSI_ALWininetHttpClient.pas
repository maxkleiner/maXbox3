...
begin
  ...
  with CL.AddClassN(CL.FindClass('TALHTTPClient'),'TALWinInetHTTPClient') do
  begin
...
begin
 ...
 CL.AddConstantN('INTERNET_STATUS_COOKIE_HISTORY','LongInt').SetInt( 327);
  ...
  CL.AddTypeS('TALWininetHttpClientInternetOptionSet', 'set of TAlWininetHttpCl'
   +'ientInternetOption');
  CL.AddTypeS('TAlWinInetHTTPClientStatusChangeEvent', 'Procedure ( sender : To'
   +'bject; InternetStatus : DWord; StatusInformation : Pointer; StatusInformat'
   +'ionLength : DWord)');
...
procedure RIRegister_TALWinInetHTTPClient(CL: TPSRuntimeClassImporter);
begin
  with CL.Add(TALWinInetHTTPClient) do
  begin
