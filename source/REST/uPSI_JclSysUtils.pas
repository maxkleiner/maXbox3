...
begin
  ...
  with CL.AddClassN(CL.FindClass('TObject'),'TJclSimpleLog') do
  begin
...
begin
  ...
  with CL.AddClassN(CL.FindClass('TObject'),'TJclIntfCriticalSection') do
  begin
...
begin
  ...
  with CL.AddClassN(CL.FindClass('TObject'),'TJclNumericFormat') do
  begin
    RegisterMethod('Constructor Create');
...
begin
  ...
  begin
    RegisterMethod('Constructor Create( const Ptr : Pointer; Size : Longint)');
  end;
end;
...
procedure SIRegister_JclSysUtils(CL: TPSPascalCompiler);
begin
 CL.AddDelphiFunction('Procedure GetAndFillMem( var P : Pointer; const Size : Integer; const Value : Byte)');
 CL.AddDelphiFunction('Procedure FreeMemAndNil( var P : Pointer)');
 ...
 CL.AddDelphiFunction('Function GetFieldTable( AClass : TClass) : PFieldTable');
  ...
  CL.AddTypeS('TMethodTable', 'record Count : Word; FirstEntry : TMethodEntry; '
   +'end');
 ...
 CL.AddDelphiFunction('Function IsClass( Address : Pointer) : Boolean');
 CL.AddDelphiFunction('Function IsObject( Address : Pointer) : Boolean');
 ...
 CL.AddDelphiFunction('Function Execute( const CommandLine : string; OutputLineCallback : TTextHandler; RawOutput : Boolean; AbortPtr : PBoolean) : Cardinal;');
 CL.AddDelphiFunction('Function Execute1( const CommandLine : string; var Output : string; RawOutput : Boolean; AbortPtr : PBoolean) : Cardinal;');
 ...
 CL.AddDelphiFunction('Function GetModuleSymbol( Module : TModuleHandle; SymbolName : string) : Pointer');
 CL.AddDelphiFunction('Function GetModuleSymbolEx( Module : TModuleHandle; SymbolName : string; var Accu : Boolean) : Pointer');
 ...
 CL.AddDelphiFunction('Function StrToBoolean( const S : string) : Boolean');
 CL.AddDelphiFunction('Function BooleanToStr( B : Boolean) : string');
 CL.AddDelphiFunction('Function IntToBool( I : Integer) : Boolean');
 CL.AddDelphiFunction('Function BoolToInt( B : Boolean) : Integer');
...
Begin Result := JclSysUtils.Execute(CommandLine, Output, RawOutput, AbortPtr); END;

(*----------------------------------------------------------------------------*)
Function Execute_P( const CommandLine : string; OutputLineCallback : TTextHandler; RawOutput : Boolean; AbortPtr : PBoolean) : Cardinal;
Begin Result := JclSysUtils.Execute(CommandLine, OutputLineCallback, RawOutput, AbortPtr); END;
...
Begin Result := Self.SignChar(Value); END;
...
Begin Result := Self.ShowSign(Value); END;
...
Begin Result := Self.IntToStr(Value, FirstDigitPos); END;

(*----------------------------------------------------------------------------*)
procedure RIRegister_TJclSimpleLog(CL: TPSRuntimeClassImporter);
begin
  with CL.Add(TJclSimpleLog) do
  begin
...
procedure RIRegister_TJclIntfCriticalSection(CL: TPSRuntimeClassImporter);
begin
  with CL.Add(TJclIntfCriticalSection) do
  begin
...
procedure RIRegister_TJclNumericFormat(CL: TPSRuntimeClassImporter);
begin
  with CL.Add(TJclNumericFormat) do
  begin
...
procedure RIRegister_TJclReferenceMemoryStream(CL: TPSRuntimeClassImporter);
begin
  with CL.Add(TJclReferenceMemoryStream) do
  begin
...
begin
 ...
 S.RegisterDelphiFunction(@Execute, 'Execute', cdRegister);
 S.RegisterDelphiFunction(@Execute1, 'Execute1', cdRegister);
 ...
 S.RegisterDelphiFunction(@StrToBoolean, 'StrToBoolean', cdRegister);
