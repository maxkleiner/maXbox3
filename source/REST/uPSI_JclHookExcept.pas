...
begin
 ...
 CL.AddDelphiFunction('Function JclBelongsHookedCode( Addr : Pointer) : Boolean');
end;
...
begin
 ...
 S.RegisterDelphiFunction(@JclAddExceptNotifier1, 'JclAddExceptNotifier1', cdRegister);
 S.RegisterDelphiFunction(@JclRemoveExceptNotifier, 'JclRemoveExceptNotifier', cdRegister);
 S.RegisterDelphiFunction(@JclRemoveExceptNotifier1, 'JclRemoveExceptNotifier1', cdRegister);
