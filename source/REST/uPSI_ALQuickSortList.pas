...
begin
  ...
  with CL.AddClassN(CL.FindClass('TALBaseAVLList'),'TALInt64AVLList') do
  begin
...
begin
  ...
  with CL.AddClassN(CL.FindClass('TObject'),'TALBaseAVLList') do
  begin
    RegisterMethod('Constructor Create');
    RegisterMethod('Procedure Clear');
    RegisterMethod('Procedure Delete( Index : Integer)');
