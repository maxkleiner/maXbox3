...
begin
  ...
  with CL.AddClassN(CL.FindClass('TOBJECT'),'TJclFileSummary') do
  begin
...
begin
  ...
  CL.AddTypeS('TFileCompressionState', '( fcNoCompression, fcDefaultCompression'
   +', fcLZNT1Compression )');
 CL.AddDelphiFunction('Function NtfsGetCompression( const FileName : TFileName; var State : Short) : Boolean;');
 CL.AddDelphiFunction('Function NtfsGetCompression1( const FileName : TFileName) : TFileCompressionState;');
 CL.AddDelphiFunction('Function NtfsSetCompression( const FileName : TFileName; const State : Short) : Boolean');
 CL.AddDelphiFunction('Procedure NtfsSetFileCompression( const FileName : TFileName; const State : TFileCompressionState)');
 ...
 CL.AddDelphiFunction('Function NtfsMountDeviceAsDrive( const Device : WideString; Drive : Char) : Boolean');
 CL.AddDelphiFunction('Function NtfsMountVolume( const Volume : WideChar; const MountPoint : WideString) : Boolean');
 ...
 CL.AddDelphiFunction('Function NtfsCreateHardLinkA( const LinkFileName, ExistingFileName : AnsiString) : Boolean');
 CL.AddDelphiFunction('Function NtfsCreateHardLinkW( const LinkFileName, ExistingFileName : WideString) : Boolean');
  CL.AddTypeS('TNtfsHardLinkInfo', 'record LinkCount : Cardinal; FileIndex : In'
   +'t64; end');
 ...
 CL.AddDelphiFunction('Function NtfsDeleteHardLinks( const FileName : string) : Boolean');
  ...
  CL.AddTypeS('TJclFileSummaryShare', '( fssDenyNone, fssDenyRead, fssDenyWrite'
   +', fssDenyAll )');
  CL.AddTypeS('TJclFileSummaryPropSetCallback', 'Function ( const FMTID : TGUID'
   +') : Boolean');
  CL.AddTypeS('TJclFileSummaryPropCallback', 'Function ( const Name : WideStrin'
   +'g; ID : TPropID; Vt : TVarType) : Boolean');
...
begin
 ...
 S.RegisterDelphiFunction(@NtfsGetCompression1, 'NtfsGetCompression1', cdRegister);
 ...
 S.RegisterDelphiFunction(@NtfsCreateHardLinkA, 'NtfsCreateHardLinkA', cdRegister);
 S.RegisterDelphiFunction(@NtfsCreateHardLinkW, 'NtfsCreateHardLinkW', cdRegister);
