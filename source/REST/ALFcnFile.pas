...
begin
  ...
  try
    for I := 0 to length(IgnoreFiles) - 1 do aIgnoreFilesLst.Add(ExcludeTrailingPathDelimiter(IgnoreFiles[i]));
...
begin
  ...
  DestDirectory := IncludeTrailingPathDelimiter(DestDirectory);
