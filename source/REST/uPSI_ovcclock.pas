...
begin
  ...
  with CL.AddClassN(CL.FindClass('TOvcCustomClock'),'TOvcClock') do
  begin
  end;
end;
...
begin
  ...
  with CL.AddClassN(CL.FindClass('TOvcCustomControlEx'),'TOvcCustomClock') do
  begin
...
begin
  ...
  with CL.AddClassN(CL.FindClass('TPersistent'),'TOvcHandOptions') do
  begin
...
begin
  ...
  with CL.AddClassN(CL.FindClass('TPersistent'),'TOvcDigitalOptions') do
  begin
...
procedure RIRegister_TOvcCustomClock(CL: TPSRuntimeClassImporter);
begin
  with CL.Add(TOvcCustomClock) do
  begin
...
procedure RIRegister_TOvcHandOptions(CL: TPSRuntimeClassImporter);
begin
  with CL.Add(TOvcHandOptions) do
  begin
...
procedure RIRegister_TOvcDigitalOptions(CL: TPSRuntimeClassImporter);
begin
  with CL.Add(TOvcDigitalOptions) do
  begin
