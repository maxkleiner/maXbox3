...
{
   over tool for GL    less types from another
}
interface
...
// CL.AddDelphiFunction('Procedure NormalizeVectorArray( list : PAffineVectorArray; n : Integer);');
 ...
 CL.AddDelphiFunction('Procedure glSinCos1( const Theta : Double; var Sin, Cos : Double);');
 CL.AddDelphiFunction('Procedure glSinCos( const Theta : Single; var Sin, Cos : Single);');
