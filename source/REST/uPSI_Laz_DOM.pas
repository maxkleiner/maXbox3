...
begin
  ...
  with CL.AddClassN(CL.FindClass('TDOMNode_WithChildren'),'TDOMElement') do
  begin
    RegisterMethod('Constructor Create( AOwner : TDOMDocument)');
    RegisterMethod('Function CloneNode( deep : Boolean; ACloneOwner : TDOMDocument) : TDOMNode');
...
begin
  ...
  with CL.AddClassN(CL.FindClass('TDOMDocument'),'TXMLDocument') do
  begin
...
begin
  ...
  with CL.AddClassN(CL.FindClass('TDOMNode'),'TDOMNode_WithChildren') do
  begin
...
(*----------------------------------------------------------------------------*)
procedure TXMLDocumentStylesheetHRef_W(Self: TXMLDocument; const T: DOMString);
Begin Self.StylesheetHRef := T; end;

(*----------------------------------------------------------------------------*)
procedure TXMLDocumentStylesheetHRef_R(Self: TXMLDocument; var T: DOMString);
Begin T := Self.StylesheetHRef; end;

(*----------------------------------------------------------------------------*)
procedure TXMLDocumentStylesheetType_W(Self: TXMLDocument; const T: DOMString);
Begin Self.StylesheetType := T; end;

(*----------------------------------------------------------------------------*)
procedure TXMLDocumentStylesheetType_R(Self: TXMLDocument; var T: DOMString);
...
(*----------------------------------------------------------------------------*)
procedure TXMLDocumentXMLVersion_W(Self: TXMLDocument; const T: DOMString);
Begin Self.XMLVersion := T; end;

(*----------------------------------------------------------------------------*)
procedure TXMLDocumentXMLVersion_R(Self: TXMLDocument; var T: DOMString);
...
procedure RIRegister_TDOMNode_WithChildren(CL: TPSRuntimeClassImporter);
begin
  with CL.Add(TDOMNode_WithChildren) do
  begin
