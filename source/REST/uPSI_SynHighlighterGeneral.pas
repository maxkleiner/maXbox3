...
begin
  ...
  with CL.AddClassN(CL.FindClass('TSynCustomHighlighter'),'TSynGeneralSyn') do
  begin
    ...
    RegisterProperty('Comments', 'TCommentStyles', iptrw);
...
begin
  ...
  CL.AddTypeS('TCommentStyle', '( csAnsiStyle, csPasStyle, csCStyle, csAsmStyle'
   +', csBasStyle, csCPPStyle )');
  CL.AddTypeS('TCommentStyles', 'set of TCommentStyle');
