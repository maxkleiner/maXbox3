...
begin
  ...
  with CL.AddClassN(CL.FindClass('TStringList'),'TGraphList') do begin
    ...
    RegisterMethod('Function AddEdge3( const node1, node2 : TNode; const newweight : integer) : boolean;');
    RegisterMethod('Function AddEdge4( const node1, node2 : TNode; const newweight, newWeight2 : integer) : boolean;');
    RegisterMethod('Function findedge( const V1, V2 : TNode; var edgePtr : PTEdge) : boolean');
...
(*----------------------------------------------------------------------------*)
Function TGraphListAddEdge4_P(Self: TGraphList;  const node1, node2 : TNode; const newweight, newWeight2 : integer) : boolean;
Begin Result := Self.AddEdge(node1, node2, newweight, newWeight2); END;

(*----------------------------------------------------------------------------*)
Function TGraphListAddEdge3_P(Self: TGraphList;  const node1, node2 : TNode; const newweight : integer) : boolean;
...
(*----------------------------------------------------------------------------*)
procedure TNodey_W(Self: TNode; const T: integer);
Begin Self.y := T; end;

(*----------------------------------------------------------------------------*)
procedure TNodey_R(Self: TNode; var T: integer);
Begin T := Self.y; end;

(*----------------------------------------------------------------------------*)
procedure TNodex_W(Self: TNode; const T: integer);
Begin Self.x := T; end;

(*----------------------------------------------------------------------------*)
procedure TNodex_R(Self: TNode; var T: integer);
Begin T := Self.x; end;

(*----------------------------------------------------------------------------*)
procedure TNodeindex_W(Self: TNode; const T: integer);
Begin Self.index := T; end;

(*----------------------------------------------------------------------------*)
procedure TNodeindex_R(Self: TNode; var T: integer);
Begin T := Self.index; end;

(*----------------------------------------------------------------------------*)
procedure TNodenbradjacents_W(Self: TNode; const T: integer);
Begin Self.nbradjacents := T; end;

(*----------------------------------------------------------------------------*)
procedure TNodenbradjacents_R(Self: TNode; var T: integer);
Begin T := Self.nbradjacents; end;

(*----------------------------------------------------------------------------*)
procedure TNodeadjacents_W(Self: TNode; const T: array of TEdge);
Begin //Self.adjacents := T;
end;

(*----------------------------------------------------------------------------*)
procedure TNodeadjacents_R(Self: TNode; var T: array of TEdge);
