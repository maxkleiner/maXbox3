...
(*----------------------------------------------------------------------------*)
procedure TBackgroundWorkerOnWork_W(Self: TBackgroundWorker; const T: TWorkEvent);
begin Self.OnWork := T; end;

(*----------------------------------------------------------------------------*)
procedure TBackgroundWorkerOnWork_R(Self: TBackgroundWorker; var T: TWorkEvent);
