...
type
  ...
  protected
    FpcProgram: PAnsiChar;
    FpcPos: PAnsiChar; // Current position [translated]
    FHistory: TStrings;
    FHistorySize: Integer;
    FHistoryPtr: Integer;
    FStyle: TIParserStyle;
  ...
  public
    ...
    property Pos: Integer read GetPos;
    // (rom) name change needed
    property pcPos: PAnsiChar read FpcPos write FpcPos;
    property pcProgram: PAnsiChar read FpcProgram write FpcProgram;
    property Style: TIParserStyle read FStyle write FStyle;
    property ReturnComments: Boolean read FReturnComments write FReturnComments;
  end;
