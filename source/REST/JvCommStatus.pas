...
type
  ...
  TJvCommWatcher = class(TThread) //class(TJvPausableThread)
  private
    FHandle: THandle;
    FStat: Cardinal;
...
procedure TJvCommWatcher.EnterUnpauseableSection;
begin
  FPauseSection.Acquire;
end;

{procedure JvCommWatcher.  .LeaveUnpauseableSection;
begin
...
procedure TJvCommWatcher.LeaveUnpauseableSection;
begin
  FPauseSection.Release;
