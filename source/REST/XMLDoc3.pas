...
{ XML Document Support adapt for mX                     }
{                                                       }
...
{ TXMLNodeList }
  ...
  TXMLNodeList3 = class(TInterfacedObject, IXMLNodeList)
  private
...
{ TXMLNode }
  ...
  TXMLNode3 = class(TInterfacedObject, IXMLNode, IXMLNodeAccess)
  private
...
{ TXMLNodeCollection }
  ...
  TXMLNodeCollection = class(  , IXMLNodeCollection)
  private
...
{ TXMLDocument }
  ...
  TXMLDocument3 = class(TComponent, IInterface, IXMLDocument, IXMLDocumentAccess)
  private
    FXMLData: DOMString;
    FSrcStream: TStream;
