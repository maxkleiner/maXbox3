...
begin
 ...
 CL.AddDelphiFunction('Function GetRValue( RGBValue : TColor) : byte');
 CL.AddDelphiFunction('Function GetGValue( RGBValue : TColor) : byte');
 CL.AddDelphiFunction('Function GetBValue( RGBValue : TColor) : byte');
