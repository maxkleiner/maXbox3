...
begin
  ...
  with CL.AddClassN(CL.FindClass('TCustomForm'),'TALHintBalloon') do
  begin
    RegisterMethod('Constructor CreateNew( AOwner : TComponent; Dummy : integer)');
    RegisterMethod('Procedure OnFormClick( Sender : TObject)');
    RegisterMethod('Procedure ShowHintBalloon( blnCreateContentProcess : TALHintBalloonCreateContentProcess; blnLeft, blnTop : integer; blnSourceControl : TControl; blnDuration : integer; blnArrowPosition : TALHintBalloonArrowPosition; blnAnimationType : TALHintBalloonAnimationType; blnAnimationSpeed : cardinal)');
...
begin
  ...
  CL.AddTypeS('TALHintBalloonMsgType', '( bmtInfo, bmtError, bmtWarning, bmtNon'
   +'e )');
  CL.AddTypeS('TALHintBalloonArrowPosition', '( bapTopLeft, bapTopRight, bapBot'
   +'tomLeft, bapBottomRight )');
  CL.AddTypeS('TALHintBalloonAnimationType', '( batNone, batBlend, batCenter, b'
   ...
   +'omToTop, batWipeLeftToRight, batWipeRightToLeft, batWipeTopToBottom, batWi'
   +'peBottomToTop )');
