...
{
    $Id: laz_dom.pas 9633 2006-07-19 09:54:40Z mattias $
...
{It does that if the classes aren't all defined in the same "type" block.
If you interrupt the "type" block to declare other things, such as
variables or constants, then the compiler will complain. Another "type"
