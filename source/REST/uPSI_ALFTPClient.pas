...
begin
  ...
  with CL.AddClassN(CL.FindClass('TObject'),'TALFTPClient') do
  begin
...
begin
  ...
  with CL.AddClassN(CL.FindClass('TObject'),'TALFTPClientProxyParams') do
  begin
    RegisterMethod('Constructor Create');
...
begin
  ...
  CL.AddTypeS('TALFTPPropertyChangeEvent', 'Procedure ( sender : Tobject; const'
   +' PropertyIndex : Integer)');
  SIRegister_TALFTPClientProxyParams(CL);
  CL.AddTypeS('TALFTPClientUploadProgressEvent', 'Procedure ( sender : Tobject;'
   +' Sent : Integer; Total : Integer)');
  CL.AddTypeS('TALFTPClientDownloadProgressEvent', 'Procedure ( sender : Tobjec'
   +'t; Read : Integer; Total : Integer)');
  CL.AddTypeS('TALFtpclientSearchRec', 'record Time : Integer; Size : Integer; '
   +'Attr : Integer; Name : AnsiString; ExcludeAttr : Integer; FindHandle : Poi'
   +'nter; FindData : TWin32FindDataA; end');
