...
begin
  ...
  with CL.AddClassN(CL.FindClass('TJvComponent'),'TJvMailSlotClient') do
  begin
    RegisterMethod('Constructor Create( AOwner : TComponent)');
    RegisterMethod('Function Send( const Msg : string) : Boolean');
    RegisterMethod('Function Send( const MessageData, MessageLength : LongWord) : Boolean;');
...
begin
  ...
  with CL.AddClassN(CL.FindClass('TJvComponent'),'TJvMailSlotServer') do
  begin
    RegisterMethod('Constructor Create( AOwner : TComponent)');
...
procedure SIRegister_JvMailSlots(CL: TPSPascalCompiler);
begin
  CL.AddTypeS('TOnNewMessage', 'Procedure ( Sender : TObject; MessageText : str'
   +'ing)');
...
(*----------------------------------------------------------------------------*)
Function TJvMailSlotClientSend_P(Self: TJvMailSlotClient;  const MessageData, MessageLength : LongWord) : Boolean;
...
procedure RIRegister_TJvMailSlotClient(CL: TPSRuntimeClassImporter);
begin
  with CL.Add(TJvMailSlotClient) do
  begin
    RegisterConstructor(@TJvMailSlotClient.Create, 'Create');
    RegisterMethod(@TJvMailSlotClient.Send, 'Send');
...
procedure RIRegister_TJvMailSlotServer(CL: TPSRuntimeClassImporter);
begin
  with CL.Add(TJvMailSlotServer) do
  begin
