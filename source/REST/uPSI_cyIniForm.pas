...
begin
  ...
  with CL.AddClassN(CL.FindClass('TComponent'),'TcyIniForm') do
  begin
    ...
    RegisterProperty('Attributes', 'TAttributes', iptrw);
...
begin
  ...
  CL.AddTypeS('TProcOnReadFile', 'Procedure ( Sender : TObject; IniFile : TInif'
   +'ile; FileVersion : String)');
  CL.AddTypeS('TProcOnReadRegistry', 'Procedure ( Sender : TObject; Registry : '
   +'TRegistry; RegistryVersion : String)');
  CL.AddTypeS('TProcOnWriteFile', 'Procedure ( Sender : TObject; IniFile : TIni'
   +'file)');
  CL.AddTypeS('TProcOnWriteRegistry', 'Procedure ( Sender : TObject; Registry :'
   +' TRegistry)');
  CL.AddTypeS('TAttribute', '( atPosition, atSize, atVisible, atMinimized, atMa'
   +'ximized )');
  CL.AddTypeS('TAttributes', 'set of TAttribute');
  CL.AddTypeS('TMode', '( mFile, mRegistry, mBoth )');
  CL.AddTypeS('TIniDirectory', '( idProgramLocation, idCommonAppData, idLocalAp'
   +'pData )');
  CL.AddTypeS('TRegRoot', '( rrKEY_CLASSES_ROOT, rrKEY_CURRENT_USER, rrKEY_LOCA'
   +'L_MACHINE, rrKEY_USERS, rrKEY_CURRENT_CONFIG )');
