...
begin
  ...
  with CL.AddClassN(CL.FindClass('TALPhpRunnerEngine'),'TALPhpNamedPipeFastCgiManager') do
  begin
...
begin
  ...
  with CL.AddClassN(CL.FindClass('TALPhpFastCgiRunnerEngine'),'TALPhpNamedPipeFastCgiRunnerEngine') do
  begin
...
begin
  ...
  with CL.AddClassN(CL.FindClass('TALPhpFastCgiRunnerEngine'),'TALPhpSocketFastCgiRunnerEngine') do
  begin
...
begin
  ...
  with CL.AddClassN(CL.FindClass('TALPhpRunnerEngine'),'TALPhpFastCgiRunnerEngine') do
  begin
  end;
end;
...
procedure RIRegister_TALPhpFastCgiRunnerEngine(CL: TPSRuntimeClassImporter);
begin
  with CL.Add(TALPhpFastCgiRunnerEngine) do
  begin
  end;
end;
