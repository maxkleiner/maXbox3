...
///	</summary>
unit Spring_Utils_WinAPI; // platform;
...
function QueryServiceConfig2A(hService: SC_HANDLE; dwInfoLevel: DWORD;
  var lpBuffer: BYTE; cbBufSize: DWORD; var pcbBytesNeeded: DWORD): BOOL; stdcall;
...
function EnumServicesStatusExA(hSCManager: SC_HANDLE; InfoLevel: SC_ENUM_TYPE;
  dwServiceType: DWORD; dwServiceState: DWORD; var lpServices: BYTE;
