...
begin
  ...
  begin
    ...
    case AValue of
      slUNKNOWN: Picture.Bitmap.LoadFromResourceName(hinstance,'RED');
      slRED: Picture.bitmap.LoadFromResourceName(hinstance,'RED');
      slYELLOW: Picture.bitmap.LoadFromResourceName(hinstance,'YELLOW');
      slGREEN: Picture.bitmap.LoadFromResourceName(hinstance,'GREEN');
    end;
  end;
end;
