...
type
  ...
  public
    ...
    function HostToNetwork(AValue: Word): Word;
    function NetworkToHost(AValue: Word): Word;
...
begin
  for i := 0 to 7 do begin
    Result[i] := TIdIPv6Address(HostToNetwork(AValue[i]));
  end;
end;
...
function TIdStack.HostToNetwork(AValue: Word): Word;
var i : Integer;
begin
  for i := 0 to 7 do begin
...
function TIdStack.NetworkToHost(AValue: Word): Word;
var i : Integer;
begin
  for i := 0 to 7 do begin
    //Result[i] := NetworkToHost(AValue[i]);
