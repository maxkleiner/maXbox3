...
begin
  ...
  with CL.AddClassN(CL.FindClass('TCustomWebDispatcher'),'TWebModule') do
  begin
  end;
end;
...
begin
  ...
  with CL.AddClassN(CL.FindClass('TDataModule'),'TCustomWebDispatcher') do
  begin
...
begin
  ...
  with CL.AddClassN(CL.FindClass('TCollectionItem'),'TWebActionItem') do
  begin
