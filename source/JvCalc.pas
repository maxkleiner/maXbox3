...
uses
  ...
  StdCtrls, Menus, ExtCtrls, Buttons, Clipbrd, JvBaseDlg;
...
uses
  ...
  JvStr16,
  {$ENDIF}
  JvVCLUtils_max, JvStrUtils, JvToolEdit, JvxCtrls;
...
type
  TJvCalcButton = class(TJvxSpeedButton)//class(TJvxSpeedButton)
  private
    FKind: TCalcBtnKind;
...
type
  ...
  private
    ...
    function FindButton(Key: Char): TJvxSpeedButton;//TJvxSpeedButton;
    procedure CMCtl3DChanged(var Message: TMessage); message CM_CTL3DCHANGED;
...
begin
  ...
  begin
    if Components[I] is TSpeedButton then
      TJvxSpeedButton(Components[I]).Style:= Ctl3DStyle[Ctl3D]  //style
    else
