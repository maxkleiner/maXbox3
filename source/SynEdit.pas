...
{$ENDIF}
    ...
    procedure CommandProcessor(Command: TSynEditorCommand; AChar: char;
      Data: pointer); virtual;
    procedure CommandProcessor2(Command: TSynEditorCommand; AChar: char); virtual;
...
procedure TCustomSynEdit.CommandProcessor2(Command: TSynEditorCommand; AChar: char);
begin
  CommandProcessor(Command, AChar, NIL);

end;

procedure TCustomSynEdit.ExecuteCommand2(Command: TSynEditorCommand; AChar: char);
begin
   ExecuteCommand(Command, AChar, NIL);
end;
