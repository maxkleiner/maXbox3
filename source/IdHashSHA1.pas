...
type
  ...
  protected
    ...
    procedure Coder;
  public
    function HashValue(AStream: TStream): T5x4LongWordRecord; overload; override;
    function HashValue(AStream: TStream; const ABeginPos, AEndPos: Int64) :  T5x4LongWordRecord;  overload;
  end;
...
function TIdHashSHA1.HashValue(AStream: TStream; const ABeginPos,
