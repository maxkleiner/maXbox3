...
begin
  ...
  with CL.AddClassN(CL.FindClass('TCustomServerSocket'),'TServerSocket') do
  begin
...
begin
  ...
  with CL.AddClassN(CL.FindClass('TCustomSocket'),'TCustomServerSocket') do
  begin
  end;
end;
...
begin
  ...
  with CL.AddClassN(CL.FindClass('TCustomSocket'),'TClientSocket') do
  begin
...
begin
  ...
  with CL.AddClassN(CL.FindClass('TStream'),'TWinSocketStream') do
  begin
...
begin
  ...
  with CL.AddClassN(CL.FindClass('TComponent'),'TAbstractSocket') do
  begin
...
begin
  ...
  with CL.AddClassN(CL.FindClass('TThread'),'TServerClientThread') do
  begin
...
begin
  ...
  with CL.AddClassN(CL.FindClass('TCustomWinSocket'),'TServerWinSocket') do
  begin
...
begin
  ...
  with CL.AddClassN(CL.FindClass('TCustomWinSocket'),'TServerClientWinSocket') do
  begin
...
begin
 ...
 CL.AddConstantN('CM_LOOKUPCOMPLETE','LongWord').SetUInt( WM_USER + $0003);
  ...
  CL.AddTypeS('TAsyncStyle', '( asRead, asWrite, asOOB, asAccept, asConnect, as'
   +'Close )');
  ...
  CL.AddTypeS('TSocketNotifyEvent', 'Procedure ( Sender : TObject; Socket : TCu'
   +'stomWinSocket)');
  SIRegister_TCustomWinSocket(CL);
  SIRegister_TClientWinSocket(CL);
  SIRegister_TServerClientWinSocket(CL);
  CL.AddTypeS('TThreadNotifyEvent', 'Procedure ( Sender : TObject; Thread : TSe'
   +'rverClientThread)');
...
procedure RIRegister_TCustomServerSocket(CL: TPSRuntimeClassImporter);
begin
  with CL.Add(TCustomServerSocket) do
  begin
  end;
end;
...
procedure RIRegister_TWinSocketStream(CL: TPSRuntimeClassImporter);
begin
  with CL.Add(TWinSocketStream) do
  begin
