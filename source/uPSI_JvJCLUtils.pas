...
begin
 ...
 CL.AddDelphiFunction('Procedure MoveString( const Source : string; var Dest : string; Count : Integer);');
...
begin
 ...
 S.RegisterDelphiFunction(@MoveString_P, 'MoveString', cdRegister);
