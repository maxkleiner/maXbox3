...
begin
  ...
  with CL.AddClassN(CL.FindClass('TForm'),'TMaxForm1') do
  begin
    ...
    RegisterMethod('Procedure UpdateService1Click( Sender : TObject)');
    RegisterMethod('Procedure PascalSchool1Click( Sender : TObject)');
    RegisterMethod('Procedure Tutorial81Click( Sender : TObject)');
    ...
    RegisterMethod('Procedure ArduinoDump1Click( Sender : TObject)');
    RegisterMethod('Procedure AndroidDump1Click( Sender : TObject)');
    ...
    RegisterMethod('Procedure DocuforAddOns1Click( Sender : TObject)');
    RegisterMethod('Procedure Tutorial14Async1Click( Sender : TObject)');
    RegisterMethod('Procedure Lessons15Review1Click( Sender : TObject)');
    ...
    RegisterMethod('Procedure Tutorial151Click( Sender : TObject)');
    ...
    RegisterMethod('Procedure CB1SCListChange( Sender : TObject)');
    ...
    RegisterMethod('Procedure HEXEditor2Click( Sender : TObject)');
    ...
    RegisterMethod('Procedure Tutorial17Server1Click( Sender : TObject)');
    RegisterMethod('Procedure Tutorial18Arduino1Click( Sender : TObject)');
    ...
    RegisterMethod('Procedure EnlargeFontConsole1Click( Sender : TObject)');
    RegisterMethod('Procedure ShrinkFontConsole1Click( Sender : TObject)');
    RegisterMethod('Procedure intfAdd1Click( Sender : TObject)');
    RegisterMethod('Procedure intfDelete1Click( Sender : TObject)');
    RegisterMethod('Procedure intfRefactor1Click( Sender : TObject)');
    RegisterMethod('Procedure Defactor1Click( Sender : TObject)');
    RegisterMethod('Procedure Tutorial19COMArduino1Click( Sender : TObject)');
    RegisterMethod('Procedure Tutorial20RegexClick( Sender : TObject)');
    RegisterMethod('Procedure ManualE1Click( Sender : TObject)');
    RegisterMethod('Procedure FullTextFinder1Click( Sender : TObject)');
    RegisterMethod('Procedure Move1Click( Sender : TObject)');
    RegisterMethod('Procedure FractalDemo1Click( Sender : TObject)');
    RegisterMethod('Procedure Tutorial21Android1Click( Sender : TObject)');
    RegisterMethod('Procedure Tutorial0Function1Click( Sender : TObject)');
    RegisterMethod('Procedure SimuLogBox1Click( Sender : TObject)');
    RegisterMethod('Procedure OpenExamples1Click( Sender : TObject)');
    RegisterMethod('Procedure JavaScriptSyntax1Click( Sender : TObject)');
    ...
    RegisterMethod('Procedure Rename1Click( Sender : TObject)');
    RegisterMethod('Procedure SynEditPrint1PrintLine( Sender : TObject; LineNumber, PageNumber : Integer)');
    RegisterMethod('Procedure Preview1Click( Sender : TObject)');
    RegisterMethod('Procedure SynEditPrint1PrintStatus( Sender : TObject; Status : TSynPrintStatus; PageNumber : Integer; var Abort : Boolean)');
    RegisterMethod('Procedure Tutorial22Services1Click( Sender : TObject)');
    RegisterMethod('Procedure Tutorial23RealTime1Click( Sender : TObject)');
    RegisterMethod('Procedure Configuration1Click( Sender : TObject)');
    RegisterMethod('Procedure MP3Player1Click( Sender : TObject)');
    ...
    RegisterMethod('Procedure EditReplace1Click( Sender : TObject)');
    ...
    RegisterMethod('Procedure Sort1IntflistClick( Sender : TObject)');
    RegisterMethod('Procedure Redo1Click( Sender : TObject)');
    RegisterMethod('Procedure Tutorial24CleanCode1Click( Sender : TObject)');
    RegisterMethod('Procedure IndentSelection1Click( Sender : TObject)');
    RegisterMethod('Procedure UnindentSection1Click( Sender : TObject)');
    ...
    RegisterMethod('Procedure SynMultiSyn1CustomRange( Sender : TSynMultiSyn; Operation : TRangeOperation; var Range : Pointer)');
    RegisterProperty('STATMemoryReport', 'boolean', iptrw);
...
procedure SIRegister_fMain(CL: TPSPascalCompiler);
begin
 CL.AddConstantN('BYTECODE','String').SetString( 'bytecode.psb');
 ...
 CL.AddConstantN('MBVERSION','String').SetString( '3.9.9.1');
...
begin
  ...
  begin
    ...
    RegisterMethod(@TMaxForm1.Tutorial71Click, 'Tutorial71Click');
    RegisterMethod(@TMaxForm1.UpdateService1Click, 'UpdateService1Click');
    RegisterMethod(@TMaxForm1.PascalSchool1Click, 'PascalSchool1Click');
    RegisterMethod(@TMaxForm1.Tutorial81Click, 'Tutorial81Click');
    ...
    RegisterMethod(@TMaxForm1.Console1Click, 'Console1Click');
    ...
    RegisterMethod(@TMaxForm1.ArduinoDump1Click, 'ArduinoDump1Click');
    RegisterMethod(@TMaxForm1.AndroidDump1Click, 'AndroidDump1Click');
    ...
    RegisterMethod(@TMaxForm1.DocuforAddOns1Click, 'DocuforAddOns1Click');
    RegisterMethod(@TMaxForm1.Tutorial14Async1Click, 'Tutorial14Async1Click');
    RegisterMethod(@TMaxForm1.Lessons15Review1Click, 'Lessons15Review1Click');
    ...
    RegisterMethod(@TMaxForm1.Tutorial151Click, 'Tutorial151Click');
    ...
    RegisterMethod(@TMaxForm1.CB1SCListChange, 'CB1SCListChange');
    ...
    RegisterMethod(@TMaxForm1.HEXEditor2Click, 'HEXEditor2Click');
    ...
    RegisterMethod(@TMaxForm1.Tutorial17Server1Click, 'Tutorial17Server1Click');
    RegisterMethod(@TMaxForm1.Tutorial18Arduino1Click, 'Tutorial18Arduino1Click');
    ...
    RegisterMethod(@TMaxForm1.EnlargeFontConsole1Click, 'EnlargeFontConsole1Click');
    RegisterMethod(@TMaxForm1.ShrinkFontConsole1Click, 'ShrinkFontConsole1Click');
    RegisterMethod(@TMaxForm1.intfAdd1Click, 'intfAdd1Click');
    RegisterMethod(@TMaxForm1.intfDelete1Click, 'intfDelete1Click');
    RegisterMethod(@TMaxForm1.intfRefactor1Click, 'intfRefactor1Click');
    RegisterMethod(@TMaxForm1.Defactor1Click, 'Defactor1Click');
    RegisterMethod(@TMaxForm1.Tutorial19COMArduino1Click, 'Tutorial19COMArduino1Click');
    RegisterMethod(@TMaxForm1.Tutorial20RegexClick, 'Tutorial20RegexClick');
    RegisterMethod(@TMaxForm1.ManualE1Click, 'ManualE1Click');
    RegisterMethod(@TMaxForm1.FullTextFinder1Click, 'FullTextFinder1Click');
    RegisterMethod(@TMaxForm1.Move1Click, 'Move1Click');
    RegisterMethod(@TMaxForm1.FractalDemo1Click, 'FractalDemo1Click');
    RegisterMethod(@TMaxForm1.Tutorial21Android1Click, 'Tutorial21Android1Click');
    RegisterMethod(@TMaxForm1.Tutorial0Function1Click, 'Tutorial0Function1Click');
    ...
    RegisterMethod(@TMaxForm1.CodeSearch1Click, 'CodeSearch1Click');
    ...
    RegisterMethod(@TMaxForm1.Rename1Click, 'Rename1Click');
    RegisterMethod(@TMaxForm1.SynEditPrint1PrintLine, 'SynEditPrint1PrintLine');
    RegisterMethod(@TMaxForm1.Preview1Click, 'Preview1Click');
    RegisterMethod(@TMaxForm1.SynEditPrint1PrintStatus, 'SynEditPrint1PrintStatus');
    RegisterMethod(@TMaxForm1.Tutorial22Services1Click, 'Tutorial22Services1Click');
    RegisterMethod(@TMaxForm1.Tutorial23RealTime1Click, 'Tutorial23RealTime1Click');
    RegisterMethod(@TMaxForm1.Configuration1Click, 'Configuration1Click');
    RegisterMethod(@TMaxForm1.MP3Player1Click, 'MP3Player1Click');
    ...
    RegisterMethod(@TMaxForm1.EditReplace1Click, 'EditReplace1Click');
    ...
    RegisterMethod(@TMaxForm1.Sort1IntflistClick, 'Sort1IntflistClick');
    RegisterMethod(@TMaxForm1.Redo1Click, 'Redo1Click');
    RegisterMethod(@TMaxForm1.Tutorial24CleanCode1Click, 'Tutorial24CleanCode1Click');
    RegisterMethod(@TMaxForm1.IndentSelection1Click, 'IndentSelection1Click');
    RegisterMethod(@TMaxForm1.UnindentSection1Click, 'UnindentSection1Click');
    ...
    RegisterMethod(@TMaxForm1.SynMultiSyn1CustomRange, 'SynMultiSyn1CustomRange');
    RegisterPropertyHelper(@TMaxForm1STATMemoryReport_R,@TMaxForm1STATMemoryReport_W,'STATMemoryReport');
    ...
    RegisterPropertyHelper(@TMaxForm1lbintflist_R,@TMaxForm1lbintflist_W,'lbintflist');
