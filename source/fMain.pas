...
uses
  ...
  uPSI_ScktComp,
  uPSI_Calendar,
  uPSI_ComCtrls, //3.6 ttreeview and listview!  richedit
...
begin
  ...
  maxForm1.Caption:= 'maXbox3 ScriptStudio  '+ExtractFilename(Act_Filename);
