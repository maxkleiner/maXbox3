...
procedure RIRegister_DB_Routines(S: TPSExec);


implementation
Uses DB, DBCommonTypes
  ,WideStrings, {$IFDEF DELPHI6UP}{$IFNDEF FPC}FMTBcd, MaskUtils,{$ENDIF}{$ENDIF}Classes;
...
(*----------------------------------------------------------------------------*)
procedure TDataSourceOnUpdateData_W(Self: TDataSource; const T: TNotifyEvent);
begin Self.OnUpdateData := T; end;

(*----------------------------------------------------------------------------*)
procedure TDataSourceOnUpdateData_R(Self: TDataSource; var T: TNotifyEvent);
begin T := Self.OnUpdateData; end;

(*----------------------------------------------------------------------------*)
procedure TDataSourceOnDataChange_W(Self: TDataSource; const T: TDataChangeEvent);
begin Self.OnDataChange := T; end;

(*----------------------------------------------------------------------------*)
procedure TDataSourceOnDataChange_R(Self: TDataSource; var T: TDataChangeEvent);
begin T := Self.OnDataChange; end;

(*----------------------------------------------------------------------------*)
procedure TDataSourceOnStateChange_W(Self: TDataSource; const T: TNotifyEvent);
begin Self.OnStateChange := T; end;

(*----------------------------------------------------------------------------*)
procedure TDataSourceOnStateChange_R(Self: TDataSource; var T: TNotifyEvent);
begin T := Self.OnStateChange; end;

(*----------------------------------------------------------------------------*)
procedure TDataSourceEnabled_W(Self: TDataSource; const T: Boolean);
begin Self.Enabled := T; end;

(*----------------------------------------------------------------------------*)
procedure TDataSourceEnabled_R(Self: TDataSource; var T: Boolean);
begin T := Self.Enabled; end;

(*----------------------------------------------------------------------------*)
procedure TDataSourceDataSet_W(Self: TDataSource; const T: TDataSet);
begin Self.DataSet := T; end;

(*----------------------------------------------------------------------------*)
procedure TDataSourceDataSet_R(Self: TDataSource; var T: TDataSet);
begin T := Self.DataSet; end;

(*----------------------------------------------------------------------------*)
procedure TDataSourceAutoEdit_W(Self: TDataSource; const T: Boolean);
begin Self.AutoEdit := T; end;

(*----------------------------------------------------------------------------*)
procedure TDataSourceAutoEdit_R(Self: TDataSource; var T: Boolean);
begin T := Self.AutoEdit; end;

(*----------------------------------------------------------------------------*)
procedure TDataSourceState_R(Self: TDataSource; var T: TDataSetState);
begin T := Self.State; end;

(*----------------------------------------------------------------------------*)
procedure TDataSetSQL_W(Self: TDataSet; const T: TStrings);
begin //Self.SQL := T;
 end;

(*----------------------------------------------------------------------------*)
procedure TDataSetSQL_R(Self: TDataSet; var T: TStrings);
begin //T:= Self.SQL;
 end;
...
procedure RIRegister_TDataSource(CL: TPSRuntimeClassImporter);
begin
  with CL.Add(TDataSource) do begin
    RegisterConstructor(@TDataSource.Create, 'Create');
    RegisterMethod(@TDataSource.Destroy, 'Free');
    RegisterMethod(@TDataSource.Edit, 'Edit');
    RegisterMethod(@TDataSource.IsLinkedTo, 'IsLinkedTo');
    RegisterPropertyHelper(@TDataSourceState_R,nil,'State');
    RegisterPropertyHelper(@TDataSourceAutoEdit_R,@TDataSourceAutoEdit_W,'AutoEdit');
    RegisterPropertyHelper(@TDataSourceDataSet_R,@TDataSourceDataSet_W,'DataSet');
    RegisterPropertyHelper(@TDataSourceEnabled_R,@TDataSourceEnabled_W,'Enabled');
    RegisterPropertyHelper(@TDataSourceOnStateChange_R,@TDataSourceOnStateChange_W,'OnStateChange');
    RegisterPropertyHelper(@TDataSourceOnDataChange_R,@TDataSourceOnDataChange_W,'OnDataChange');
    RegisterPropertyHelper(@TDataSourceOnUpdateData_R,@TDataSourceOnUpdateData_W,'OnUpdateData');
  end;
end;
...
procedure RIRegisterTDATASET(Cl: TPSRuntimeClassImporter);
Begin
with Cl.Add(TDATASET) do begin
   RegisterConstructor(@TDATASET.Create, 'Create');
   RegisterMethod(@TDATASET.Destroy, 'Free');
...
procedure RIRegisterTBLOBFIELD(Cl: TPSRuntimeClassImporter);
Begin
with Cl.Add(TBLOBFIELD) do begin
  RegisterConstructor(@TBLOBFIELD.Create, 'Create');
  RegisterConstructor(@TBLOBFIELD.Clear, 'Clear');
  RegisterMethod(@TBLOBFIELD.Assign, 'Assign');
...
//  RegisterMethod(@TFIELD.GETDATA, 'GETDATA');
  ...
  RegisterVirtualMethod(@TFIELD.ISBlob, 'ISBlob');
...
procedure RIRegisterTLOOKUPLIST(Cl: TPSRuntimeClassImporter);
Begin
with Cl.Add(TLOOKUPLIST) do begin
...
procedure RIRegisterTFIELDLIST(Cl: TPSRuntimeClassImporter);
Begin
with Cl.Add(TFIELDLIST) do begin
...
procedure RIRegisterTFIELDDEFLIST(Cl: TPSRuntimeClassImporter);
Begin
with Cl.Add(TFIELDDEFLIST) do begin
...
procedure RIRegisterTINDEXDEFS(Cl: TPSRuntimeClassImporter);
Begin
with Cl.Add(TINDEXDEFS) do begin
...
with Cl.Add(TINDEXDEF) do begin
  ...
  RegisterMethod(@TINDEXDEF.Assign, 'Assign');
{$IFNDEF FPC}
...
procedure RIRegisterTFIELDDEFS(Cl: TPSRuntimeClassImporter);
Begin
with Cl.Add(TFIELDDEFS) do begin
...
procedure RIRegisterTFIELDDEF(Cl: TPSRuntimeClassImporter);
Begin
with Cl.Add(TFIELDDEF) do begin
...
{$IFNDEF FPC}
  ...
  RegisterMethod(@TFIELDDEF.Assign, 'Assign');
...
procedure RIRegister_TCustomConnection(CL: TPSRuntimeClassImporter);
begin
  with CL.Add(TCustomConnection) do begin
    RegisterMethod(@TCustomConnectionOpen_P, 'Open');
    RegisterMethod(@TCustomConnection.Close, 'Close');
    //RegisterConstructor(@TCustomConnection.Create, 'Create');
...
procedure RIRegister_EUpdateError(CL: TPSRuntimeClassImporter);
begin
  with CL.Add(EUpdateError) do begin
...
begin
 ...
 S.RegisterDelphiFunction(@ExtractFieldName, 'ExtractFieldName', cdRegister);
 S.RegisterDelphiFunction(@RegisterFields, 'RegisterFields', cdRegister);
 S.RegisterDelphiFunction(@DatabaseError, 'DatabaseError', cdRegister);
 S.RegisterDelphiFunction(@DatabaseErrorFmt, 'DatabaseErrorFmt', cdRegister);
 S.RegisterDelphiFunction(@DisposeMem, 'DisposeMem', cdRegister);
 S.RegisterDelphiFunction(@BuffersEqual, 'BuffersEqual', cdRegister);
 S.RegisterDelphiFunction(@GetFieldProperty, 'GetFieldProperty', cdRegister);
 S.RegisterDelphiFunction(@VarTypeToDataType, 'VarTypeToDataType', cdRegister);
end;
...
RIRegister_TDataSource(CL);  //3.6.1
RIRegisterTDATASET(Cl);

  RIRegister_EUpdateError(CL);
  RIRegister_TCustomConnection(CL);
  //RIRegister_DB_Routines(CL); // comment it if no routines
