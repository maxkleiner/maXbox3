...
firs the function processpath and second 3 objects
}
interface
...
procedure SIRegister_FileCtrl(CL: TPSPascalCompiler);
begin
  CL.AddTypeS('TFileAttr', '( ftReadOnly, ftHidden, ftSystem, ftVolumeID, ftDir'
   +'ectory, ftArchive, ftNormal )');
  CL.AddTypeS('TFileType', 'set of TFileAttr');
  CL.AddTypeS('TDriveType', '( dtUnknown, dtNoDrive, dtFloppy, dtFixed, dtNetwo'
   +'rk, dtCDROM, dtRAM )');
 ...
 CL.AddConstantN('WNTYPE_DRIVE','LongInt').SetInt( 1);
  ...
  CL.AddTypeS('TSelectDirExtOpt', '( sdNewFolder, sdShowEdit, sdShowShares, sdN'
   +'ewUI, sdShowFiles, sdValidateDir )');
