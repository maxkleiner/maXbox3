...
Known Issues:
-----------------------------------------------------------------------------}
// $Id: JvUrlListGrabber.pas,v 1.35 2004/09/01 15:06:54 ahuser Exp $
...
type
  ...
  private
    ...
    // events
    FOnDoneFile: TJvGrabberDoneFileEvent; // file is done
    FOnDoneStream: TJvGrabberDoneStreamEvent; // stream is done
    FOnError: TJvGrabberErrorEvent; // error occured
...
begin
  ...
  UserName := '';
  Password := '';
  FileName := 'DefaultURLGrabberOutputFileName.txt';
  OutputMode := omFile;
end;
...
begin
  ...
  FFileName := 'DefaultOutputFileName.txt';
  FAgent := 'JediAgent';
  FUserName := '';
  FPassword := '';
  FFileName := 'DefaultOutputFileName.txt';
