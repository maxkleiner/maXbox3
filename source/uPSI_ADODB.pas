...
begin
  ...
  CL.AddTypeS('TCursorType', '( ctUnspecified, ctOpenForwardOnly, ctKeyset, ctDynamic, ctStatic )');
  CL.AddTypeS('TEventStatus', '( esOK, esErrorsOccured, esCantDeny, esCancel, esUnwantedEvent )');
  ...
  CL.AddTypeS('TIsolationLevel', '( ilUnspecified, ilChaos, ilReadUncommitted, '
   +'ilBrowse, ilCursorStability, ilReadCommitted, ilRepeatableRead, ilSerializable, ilIsolated )');
  CL.AddTypeS('TADOLockType', '( ltUnspecified, ltReadOnly, ltPessimistic, ltOptimistic, ltBatchOptimistic )');
 ...
 // CL.AddTypeS('TPropList', 'array of PPropInfo');
  ...
  {CL.AddTypeS('TFieldChangeCompleteEvent', 'Procedure ( DataSet : TCustomADODat'
   +'aSet; const FieldCount : Integer; const Fields : Variant; const Error :'
