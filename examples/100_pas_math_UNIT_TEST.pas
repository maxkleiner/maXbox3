...
Procedure Get_Parametric(Var vResult: Parametric ; P1,P2:double) ;
Procedure Get_Line_3D	(Var vResult: Line_3D    ; P1,P2:Point_3D) ;
Procedure Get_Line_2D	(Var vResult: Line_2D    ; P1,P2:Point_2D) ;
Procedure Get_Point_3D	(Var vResult: Point_3D   ; L:Line_3D ; T:double) ;
Procedure Get_Point_2D	(Var vResult: Point_2D   ; L:Line_2D ; T:double) ;
Procedure Get_Normal_2D	(Var vResult: Line_2D    ; L:Line_2D ; P:Point_2D) ;

Procedure Identity	(Var vResult: AMatrix3) ;
Procedure Translate	(Var vResult: AMatrix3 ; Tx,Ty:double) ;
Procedure Scale		(Var vResult: AMatrix3 ; Sx,Sy:double) ;
Procedure Rotate	(Var vResult: AMatrix3 ; Radians:double) ;
Procedure Multiply	(Var vResult: AMatrix3 ; M1,M2: AMatrix3) ;
Procedure Transform	(Var vResult: AVector3 ; M: AMatrix3 ; V: AVector3) ;  
...
Procedure Get_Line_3D (Var vResult:Line_3D ; P1,P2:Point_3D) ;
Begin	(***)
	Get_Parametric (vResult.X, P1.X, P2.X) ;
	Get_Parametric (vResult.Y, P1.Y, P2.Y) ;
	Get_Parametric (vResult.Z, P1.Z, P2.Z) ;
End ;
...
Procedure Get_Point_3D (Var vResult:Point_3D ; L:Line_3D ; T:double) ;
Begin	(***)
	vResult.X := Get_Value(L.X, T) ;
	vResult.Y := Get_Value(L.Y, T) ;
	vResult.Z := Get_Value(L.Z, T) ;
End ;
