...
begin
 ...
 CL.AddDelphiFunction('Function FileName( s : string) : string');
 CL.AddDelphiFunction('Function ParentPath( path : string) : string');
...
begin
 ...
 S.RegisterDelphiFunction(@FileName, 'FileName', cdRegister);
