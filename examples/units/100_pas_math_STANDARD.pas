...
Procedure Get_Parametric(Var Result:Parametric ; P1,P2:double) ;
Procedure Get_Line_3D	(Var Result:Line_3D    ; P1,P2:Point_3D) ;
Procedure Get_Line_2D	(Var Result:Line_2D    ; P1,P2:Point_2D) ;
Procedure Get_Point_3D	(Var Result:Point_3D   ; L:Line_3D ; T:double) ;
Procedure Get_Point_2D	(Var Result:Point_2D   ; L:Line_2D ; T:double) ;
Procedure Get_Normal_2D	(Var Result:Line_2D    ; L:Line_2D ; P:Point_2D) ;

Procedure Identity	(Var Result:Matrix3) ;
Procedure Translate	(Var Result:Matrix3 ; Tx,Ty:double) ;
Procedure Scale		(Var Result:Matrix3 ; Sx,Sy:double) ;
Procedure Rotate	(Var Result:Matrix3 ; Radians:double) ;
