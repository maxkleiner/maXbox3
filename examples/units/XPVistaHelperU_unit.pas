...
procedure CoCreateInstanceAsAdmin(
  ...
  out aObj: TObject );              // interface pointer
...
type
  ...
  TDrivesProperty = array[1..26] of boolean;
...
const
 ...
 var  PrivilegeSet : boolean; // = false;   // true, wenn SetTimePrivilege erfolgreich aufgerufen
...
//var
    //(/7pOSVersionInfo : Windows.POSVersionInfo;
