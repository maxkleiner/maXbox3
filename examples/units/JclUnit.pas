...
const
  ...
  aCelsiusFreezingPoint    = 0.0;
  aFahrenheitFreezingPoint = 32.0;
  aKelvinFreezingPoint     = 273.15;
  ...
  aCelsiusAbsoluteZero     = -273.15;
  aFahrenheitAbsoluteZero  = -459.67;
  aKelvinAbsoluteZero      = 0.0;

  { Mathematical constants }

  aDegPerCycle      = 360.0;
  aDegPerGrad       = 0.9;
  aDegPerRad        = 57.295779513082320876798154814105;
  aGradPerCycle     = 400.0;
  aGradPerDeg       = 1.1111111111111111111111111111111;
  aGradPerRad       = 63.661977236758134307553505349006;
  aRadPerCycle      = 6.283185307179586476925286766559;
  aRadPerDeg        = 0.017453292519943295769236907684886;
  aRadPerGrad       = 0.015707963267948966192313216916398;
  aCyclePerDeg      = 0.0027777777777777777777777777777778;
  aCyclePerGrad     = 0.0025;
  aCyclePerRad      = 0.15915494309189533576888376337251;
  aArcMinutesPerDeg        = 60.0;
  aArcSecondsPerArcMinute  = 60.0;
  aArcSecondsPerDeg        = ArcSecondsPerArcMinute * ArcMinutesPerDeg;
  aDegPerArcMinute         = 1/ArcMinutesPerDeg;
  aDegPerArcSecond         = 1/aArcSecondsPerDeg;
...
function DegToDmsStr(const Degrees: Float; const SecondPrecision: Cardinal): string;
...
begin
  ...
  Result := Abs(D) + M * aDegPerArcMinute + S * aDegPerArcSecond;
  if D < 0 then
    Result := -Result;
end;
