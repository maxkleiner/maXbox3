...
(* === run-time registration functions === *)
(*----------------------------------------------------------------------------*)
procedure TForm1Label12_W(Self: TForm1; const T: TLabel);
Begin Self.Label12 := T; end;

(*----------------------------------------------------------------------------*)
procedure TForm1Label12_R(Self: TForm1; var T: TLabel);
Begin T := Self.Label12; end;

(*----------------------------------------------------------------------------*)
procedure TForm1Label11_W(Self: TForm1; const T: TLabel);
Begin Self.Label11 := T; end;

(*----------------------------------------------------------------------------*)
procedure TForm1Label11_R(Self: TForm1; var T: TLabel);
Begin T := Self.Label11; end;

(*----------------------------------------------------------------------------*)
procedure TForm1Label10_W(Self: TForm1; const T: TLabel);
Begin Self.Label10 := T; end;

(*----------------------------------------------------------------------------*)
procedure TForm1Label10_R(Self: TForm1; var T: TLabel);
Begin T := Self.Label10; end;

(*----------------------------------------------------------------------------*)
procedure TForm1Label9_W(Self: TForm1; const T: TLabel);
Begin Self.Label9 := T; end;

(*----------------------------------------------------------------------------*)
procedure TForm1Label9_R(Self: TForm1; var T: TLabel);
Begin T := Self.Label9; end;

(*----------------------------------------------------------------------------*)
procedure TForm1Label8_W(Self: TForm1; const T: TLabel);
Begin Self.Label8 := T; end;

(*----------------------------------------------------------------------------*)
procedure TForm1Label8_R(Self: TForm1; var T: TLabel);
Begin T := Self.Label8; end;

(*----------------------------------------------------------------------------*)
procedure TForm1Label7_W(Self: TForm1; const T: TLabel);
Begin Self.Label7 := T; end;

(*----------------------------------------------------------------------------*)
procedure TForm1Label7_R(Self: TForm1; var T: TLabel);
...
(*----------------------------------------------------------------------------*)
procedure TForm1btn_loop_W(Self: TForm1; const T: TButton);
Begin Self.btn_loop := T; end;

(*----------------------------------------------------------------------------*)
procedure TForm1btn_loop_R(Self: TForm1; var T: TButton);
Begin T := Self.btn_loop; end;

(*----------------------------------------------------------------------------*)
procedure TForm1chk_led5_W(Self: TForm1; const T: TCheckBox);
Begin Self.chk_led5 := T; end;

(*----------------------------------------------------------------------------*)
procedure TForm1chk_led5_R(Self: TForm1; var T: TCheckBox);
Begin T := Self.chk_led5; end;

(*----------------------------------------------------------------------------*)
procedure TForm1chk_led4_W(Self: TForm1; const T: TCheckBox);
Begin Self.chk_led4 := T; end;

(*----------------------------------------------------------------------------*)
procedure TForm1chk_led4_R(Self: TForm1; var T: TCheckBox);
Begin T := Self.chk_led4; end;

(*----------------------------------------------------------------------------*)
procedure TForm1chk_led3_W(Self: TForm1; const T: TCheckBox);
Begin Self.chk_led3 := T; end;

(*----------------------------------------------------------------------------*)
procedure TForm1chk_led3_R(Self: TForm1; var T: TCheckBox);
Begin T := Self.chk_led3; end;

(*----------------------------------------------------------------------------*)
procedure TForm1chk_led2_W(Self: TForm1; const T: TCheckBox);
Begin Self.chk_led2 := T; end;

(*----------------------------------------------------------------------------*)
procedure TForm1chk_led2_R(Self: TForm1; var T: TCheckBox);
Begin T := Self.chk_led2; end;

(*----------------------------------------------------------------------------*)
procedure TForm1chk_led1_W(Self: TForm1; const T: TCheckBox);
Begin Self.chk_led1 := T; end;

(*----------------------------------------------------------------------------*)
procedure TForm1chk_led1_R(Self: TForm1; var T: TCheckBox);
Begin T := Self.chk_led1; end;

(*----------------------------------------------------------------------------*)
procedure TForm1btn_Setup_W(Self: TForm1; const T: TButton);
Begin Self.btn_Setup := T; end;

(*----------------------------------------------------------------------------*)
procedure TForm1btn_Setup_R(Self: TForm1; var T: TButton);
Begin T := Self.btn_Setup; end;

(*----------------------------------------------------------------------------*)
procedure TForm1StatusBar1_W(Self: TForm1; const T: TStatusBar);
Begin Self.StatusBar1 := T; end;

(*----------------------------------------------------------------------------*)
procedure TForm1StatusBar1_R(Self: TForm1; var T: TStatusBar);
Begin T := Self.StatusBar1; end;

(*----------------------------------------------------------------------------*)
procedure TForm1ComPort1_W(Self: TForm1; const T: TComPort);
Begin Self.ComPort1 := T; end;

(*----------------------------------------------------------------------------*)
procedure TForm1ComPort1_R(Self: TForm1; var T: TComPort);
Begin T := Self.ComPort1; end;

(*----------------------------------------------------------------------------*)
procedure TForm1btn_connect_W(Self: TForm1; const T: TButton);
Begin Self.btn_connect := T; end;

(*----------------------------------------------------------------------------*)
procedure TForm1btn_connect_R(Self: TForm1; var T: TButton);
...
begin
  ...
  begin
    ...
    RegisterMethod(@TForm1.btn_connectClick, 'btn_connectClick');
    RegisterMethod(@TForm1.btn_SetupClick, 'btn_SetupClick');
    RegisterMethod(@TForm1.FormCreate, 'FormCreate');
    RegisterMethod(@TForm1.chk_led1Click, 'chk_led1Click');
    RegisterMethod(@TForm1.chk_led2Click, 'chk_led2Click');
    RegisterMethod(@TForm1.chk_led3Click, 'chk_led3Click');
    RegisterMethod(@TForm1.chk_led4Click, 'chk_led4Click');
    RegisterMethod(@TForm1.chk_led5Click, 'chk_led5Click');
    RegisterMethod(@TForm1.FormClose, 'FormClose');
    RegisterMethod(@TForm1.btn_loopClick, 'btn_loopClick');
  end;
end;
