{ ******************************************************************
  Unit @dmath.dll - Interface for DMATH.DLL maXbox Tester  locs=1791
  ****************************************************************** }
...
//Task: to search & replace with a RegEx from function name to @dmath.dll identifier
//Ex.  from  procedure DimVector(var V : TVector; Ub : Integer); external '@dmath.dll';
//       to  procedure DimVector(var V : TVector; Ub : Integer); external 'DimVector@dmath.dll';
