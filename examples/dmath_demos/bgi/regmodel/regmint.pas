{ ******************************************************************
  ...
  The parameters are: B(0) = Km, B(1) = x0, B(2) = k0
...
{ ------------------------------------------------------------------
  ...
  begin
    ...
    { Km and x0 may be negative in the case of
      product inhibition, but k0 is always positive }

    SetParamBounds(0, -100, 100);
    SetParamBounds(1, -100, 100);
    SetParamBounds(2, 0, 100);
  end;
...
begin
  ...
  MintFit(X, Y, 1, N, MaxIter, Tol, B, V);
