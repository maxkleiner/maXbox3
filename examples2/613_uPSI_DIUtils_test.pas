...
begin
 ...
 writeln('diGetCurrentFolder: '+diGetCurrentFolder)
 writeln('diGetPersonalFolder: '+diGetPersonalFolder(1))
 writeln('diGetFileSize: '+inttoStr64(GetFileSize(exepath+'maxbox3.exe')))
